/*
* File   : $Source: /alkacon/cvs/opencms/src-modules/com/opencms/core/Attic/CmsResponseHttpServlet.java,v $
...
public class CmsResponseHttpServlet implements I_CmsResponse {
    ...
    private OutputStream m_orgOutputStream;
    ...
    public CmsResponseHttpServlet(HttpServletRequest req, HttpServletResponse res) {
        ...
        m_res.setHeader("Server", "OpenCms/" + OpenCms.getSystemInfo().getVersionNumber());
    }
    ...
    public static boolean checkJsdk() {
        ...
        if (CmsLog.LOG.isDebugEnabled()) {
            if (result) {
                // We have JSDK 2
                CmsLog.LOG.debug("Compatibility check - JSDK 2 detected. ");
            } else {
                // We have JSDK 1
                CmsLog.LOG.debug("Compatibility check - JSDK 1 detected. ");
            }
        }
        return result;
    }
