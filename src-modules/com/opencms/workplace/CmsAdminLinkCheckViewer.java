/*
* File   : $Source: /alkacon/cvs/opencms/src-modules/com/opencms/workplace/Attic/CmsAdminLinkCheckViewer.java,v $
        ...
        if("ok".equalsIgnoreCase((String)parameters.get("step"))){
            ...
            try {
                ...
                while(keys.hasMoreElements()) {
                    ...
                    if(curKey.equals(CmsLinkCheck.C_LINKCHECKTABLE_DATE)){
