...
public class CmsPublishBrokenRelationsList extends A_CmsListExplorerDialog {
    ...
    /** list id constant. */
    public static final String LIST_ID = "pbr";

    /** The internal collector instance. */
    private I_CmsListResourceCollector m_collector;

    /** The broken relations validator object. */
    private CmsRelationPublishValidator m_validator;
     ...
     */
    public CmsPublishBrokenRelationsList(CmsJspActionElement jsp, String relativeTo) {
