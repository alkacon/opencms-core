...
public class CmsUsersList extends A_CmsListDialog {
    ...
    public void executeListMultiActions() throws CmsRuntimeException {
        ...
        if (getParamListAction().equals(LIST_MACTION_DELETE)) {
            ...
            params.put(PARAM_USERID, getParamSelItems());
    ...
    public CmsUsersList(CmsJspActionElement jsp) {
        ...
        super(jsp, LIST_ID, Messages.get().container(Messages.GUI_USERS_LIST_NAME_0), LIST_COLUMN_LOGIN, CmsListOrderEnum.ORDER_ASCENDING, null);
    }
