/*
 * File   : $Source: /alkacon/cvs/opencms/src-modules/org/opencms/workplace/tools/users/Attic/A_CmsUserGroupsList.java,v $
...
public abstract class A_CmsUserGroupsList extends A_CmsListDialog {
    ...
    protected void setColumns(CmsListMetadata metadata) {
        ...
        if (!getListId().equals(CmsNotUserGroupsList.LIST_ID)) {
            ...
            CmsGroupStateAction iconAction = new CmsGroupStateAction(
                getListId(),
                LIST_ACTION_ICON,
                getCms(),
                getParamUsername());
