...
/**
 * Cache administration tool handler that hides the tool if the current user
 ...
 * @since 6.0.0 
 */
public class CmsCacheAdminToolHandler extends A_CmsToolHandler {
