...
/**
 * Link validation tool handler that hides the tools if the current user
 ...
 * @since 6.0.0 
 */
public class CmsLinkValidationToolHandler extends A_CmsToolHandler {
