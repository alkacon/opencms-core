/*
 * File   : $Source: /alkacon/cvs/opencms/src-modules/org/opencms/workplace/tools/link/Attic/CmsRelationsValidatorReport.java,v $
 ...
 * @since 6.0.0 
 */
public class CmsRelationsValidatorReport extends CmsReport {

    /** The dialog type. */
    public static final String DIALOG_TYPE = "relations_validator";
     ...
     */
    public CmsRelationsValidatorReport(CmsJspActionElement jsp) {
     ...
     */
    public CmsRelationsValidatorReport(PageContext context, HttpServletRequest req, HttpServletResponse res) {
    ...
    public void actionReport() throws JspException {
        ...
        switch (getAction()) {
            ...
            default:
                CmsRelationsValidatorThread thread = new CmsRelationsValidatorThread(getCms());
