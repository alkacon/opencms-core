/*
 * File   : $Source: /alkacon/cvs/opencms/src-modules/org/opencms/frontend/templateone/form/CmsSelectionField.java,v $
...
public class CmsSelectionField extends A_CmsField {
    ...
    public String buildHtml(CmsJspActionElement jsp, CmsForm formConfiguration, CmsMessages messages, String errorKey) {
        ...
        buf.append(messages.key("form.html.field.start"))
            .append("<select name=\"").append(getName()).append("\"")
        ...
        while (i.hasNext()) {
            ...
            buf.append("<option value=\"").append(curOption.getValue()).append("\"").append(selected).append(">").append(curOption.getLabel()).append("</option>\n");
        }
