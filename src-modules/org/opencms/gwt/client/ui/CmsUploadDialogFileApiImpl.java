/*
 * File   : $Source: /alkacon/cvs/opencms/src-modules/org/opencms/gwt/client/ui/Attic/CmsUploadDialogFileApiImpl.java,v $
...
public class CmsUploadDialogFileApiImpl extends CmsUploadDialogFormDataImpl {
    ...
    public void submit() {
        ...
        upload(
            ...
            CmsCoreData.UPLOAD_FILE_NAME_URL_ENCODED_FLAG,
    ...
    private native void upload(
		...
		function errorHandler(evt) {
			dialog.@org.opencms.gwt.client.ui.CmsUploadDialogFileApiImpl::onBrowserError(Ljava/lang/String;)(evt.target.error.code);
		}
		...
		function loaded(evt) {
			...
			if (filesToUpload.length > ++curIndex) {
				...
				xhr.onreadystatechange = function() {
					if (xhr.readyState == 4) {
						if (xhr.status == 200) {
							dialog.@org.opencms.gwt.client.ui.CmsUploadDialogFileApiImpl::parseResponse(Ljava/lang/String;)(xhr.responseText);
						} else if (xhr.status != 200) {
							dialog.@org.opencms.gwt.client.ui.CmsUploadDialogFileApiImpl::showErrorReport(Ljava/lang/String;Ljava/lang/String;)(xhr.statusText, null);
						}
					}
				}
