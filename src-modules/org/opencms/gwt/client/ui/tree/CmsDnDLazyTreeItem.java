/*
 * File   : $Source: /alkacon/cvs/opencms/src-modules/org/opencms/gwt/client/ui/tree/Attic/CmsDnDLazyTreeItem.java,v $
 ...
 * @since 8.0.0
 */
public class CmsDnDLazyTreeItem extends CmsDnDTreeItem {

    /**
     * Helper tree item which displays a "loading" message.<p>
     */
    protected class LoadingItem extends CmsDnDTreeItem {
        ...
        /**
         * @see org.opencms.gwt.client.ui.tree.CmsDnDTreeItem#enableDnD(org.opencms.gwt.client.ui.CmsDnDListHandler)
         */
        @Override
        ...
        /**
         * @see org.opencms.gwt.client.ui.tree.CmsDnDTreeItem#disableDnD()
         */
        @Override
     ...
     */
    public CmsDnDLazyTreeItem(CmsCheckBox checkbox, Widget widget) {
     ...
     * @param widget the main widget 
     */
    public CmsDnDLazyTreeItem(Widget widget) {
