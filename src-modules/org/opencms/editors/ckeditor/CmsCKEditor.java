/*
 * File   : $Source: /alkacon/cvs/opencms/src-modules/org/opencms/editors/ckeditor/CmsCKEditor.java,v $
...
/**
 * Creates the output for editing a page with the open source CKEditor editor.<p>
 * 
 * The following editor uses this class:
 * <ul>
 * <li>/editors/ckeditor/editor.jsp
 * </ul>
 * <p>
 *
 ...
 * @since 8.0
 */
public class CmsCKEditor extends CmsSimplePageEditor {
     ...
     */
    public CmsCKEditor(CmsJspActionElement jsp) {
    ...
    protected String prepareContent(boolean save) {
        ...
        if (save) {
            ...
            if (CmsStringUtil.isEmptyOrWhitespaceOnly(conversionSetting)) {
                // by default we want to pretty-print and XHTML format when saving the content in CKeditor
