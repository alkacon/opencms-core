/*
 * File   : $Source: /alkacon/cvs/opencms/src-modules/org/opencms/editors/ckeditor/CmsCKEditorConfiguration.java,v $
...
/**
 * The configuration is passed to the external CKEditor JavaScript configuration file.<p>
 * 
 ...
 * @since 8.0
 */
public class CmsCKEditorConfiguration {

    /** Session attribute name to use when storing an object instance in the session. */
    public static final String SESSION_ATTRIBUTE = "__ckeditorconfig";
     ...
     */
    public CmsCKEditorConfiguration() {
     ...
     */
    public static CmsCKEditorConfiguration getConfiguration(HttpSession session) {

        Object o = session.getAttribute(SESSION_ATTRIBUTE);
        if ((o != null) && (o instanceof CmsCKEditorConfiguration)) {
            session.removeAttribute(SESSION_ATTRIBUTE);
            return (CmsCKEditorConfiguration)o;
        }
        return new CmsCKEditorConfiguration();
    }
