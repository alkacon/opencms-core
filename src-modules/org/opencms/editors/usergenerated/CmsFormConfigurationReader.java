 ...
 */
public class CmsFormConfigurationReader {
     ...
     */
    public CmsFormConfigurationReader(CmsObject cms) {
     ...
     */
    public CmsFormConfiguration readConfiguration(CmsFile configFile) throws CmsException {
