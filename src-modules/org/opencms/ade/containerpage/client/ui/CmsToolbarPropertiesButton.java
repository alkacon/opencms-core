 ...
 * @since 8.0.0
 */
public class CmsToolbarPropertiesButton extends A_CmsContainerpageToolbarButton {

    /**
     * Constructor.<p>
     */
    public CmsToolbarPropertiesButton() {

        super(CmsToolbarButton.ToolbarIcon.PROPERTIES, "Properties", "properties", true, true);
