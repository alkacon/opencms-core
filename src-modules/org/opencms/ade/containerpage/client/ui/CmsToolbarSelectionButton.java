 ...
 * @since 8.0.0
 */
public class CmsToolbarSelectionButton extends A_CmsContainerpageToolbarButton {
    ...
    public CmsToolbarSelectionButton() {
        ...
        super(CmsToolbarButton.ToolbarIcon.SELECTION, "Selection", "selection", true, true);
