 ...
 * @since 8.0.
 */
public class CmsTypeListItem extends CmsSimpleListItem implements ClickHandler, I_CmsItemId {
     ...
     */
    public CmsTypeListItem(CmsGalleryInfoBean infoBean, Widget... content) {
    ...
    public void onClick(ClickEvent event) {
        ...
        if (sender instanceof ToggleButton) {
            m_infoBean.getSearchObject().handleClickedType(getId());
        }
    }
