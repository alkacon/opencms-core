 ...
 * @since 8.0.
 */
public class CmsCategoryListItem extends CmsSimpleListItem implements ClickHandler, I_CmsItemId {
     ...
     */
    public CmsCategoryListItem(CmsGalleryInfoBean infoBean, Widget... content) {
    ...
    public void onClick(ClickEvent event) {
        ...
        if (sender instanceof ToggleButton) {
            m_infoBean.getSearchObject().handleClickedCategory(getId());
        }
    }
