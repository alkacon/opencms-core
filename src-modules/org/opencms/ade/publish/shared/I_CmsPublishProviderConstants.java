...
/**
 * The interface containing the constants for the publish provider.<p>
 * 
 ...
 * @since 8.0.0
 */
public interface I_CmsPublishProviderConstants {

    /** The name of the dictionary to use. */
    String DICT_NAME = "org.opencms.ade.publish";
}
