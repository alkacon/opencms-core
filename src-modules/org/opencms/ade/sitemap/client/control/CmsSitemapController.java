...
public class CmsSitemapController {
    ...
    public void create(CmsClientSitemapEntry newEntry) {
        ...
        addChange(new CmsClientSitemapChangeNew(newEntry), false, false);
    }
    ...
    public void delete(String sitePath) {
        ...
        assert (entry != null);
        addChange(new CmsClientSitemapChangeDelete(entry), false, false);
    }
    ...
    public void edit(CmsClientSitemapEntry entry, String title, String vfsReference, Map<String, String> properties) {
        ...
        // apply changes
        addChange(new CmsClientSitemapChangeEdit(entry, newEntry), false, false);
    }
    ...
    public void move(CmsClientSitemapEntry entry, String toPath, int position) {
        ...
        addChange(
            new CmsClientSitemapChangeMove(entry.getSitePath(), entry.getPosition(), toPath, position),
            false,
            false);
    }
     ...
     * @param dnd if change was generated by drag and drop
     */
    private void addChange(I_CmsClientSitemapChange change, boolean redo, boolean dnd) {
