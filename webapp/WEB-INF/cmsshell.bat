...
set CLASSPATH= %CLASSPATH%;lib/commons-httpclient-2.0.1.jar
...
set CLASSPATH= %CLASSPATH%;lib/mysql-connector-java-3.0.14-production-bin.jar
...
set CLASSPATH= %CLASSPATH%;lib/jug-1.1.1.jar
@rem set CLASSPATH= %CLASSPATH%;lib/xerces-1_4_4.jar
set CLASSPATH= %CLASSPATH%;lib/dom4j-1.5-rc1.jar
...
set CLASSPATH= %CLASSPATH%;lib/quartz-1.4.1mod.jar
