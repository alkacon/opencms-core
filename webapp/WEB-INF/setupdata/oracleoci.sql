...
CREATE TABLE CMS_EXPORT_LINKS (
	...
	PROCESSED INT,
	CONSTRAINT PK_EXPORT_LINKS PRIMARY KEY(LINK_ID) USING INDEX TABLESPACE $$indexTablespace$$ ,
	CONSTRAINT UK_EXPORT_LINKS UNIQUE(LINK) USING INDEX TABLESPACE $$indexTablespace$$
);
...
CREATE TABLE CMS_OFFLINE_LINKS (
	...
	CONSTRAINT UK_OFFLINE_LINKS UNIQUE(PAGE_ID, LINK_DEST) USING INDEX TABLESPACE $$indexTablespace$$
);

CREATE TABLE CMS_ONLINE_LINKS (
	PAGE_ID VARCHAR2(36) NOT NULL,
	LINK_DEST VARCHAR2(255),
	CONSTRAINT UK_ONLINE_LINKS UNIQUE(PAGE_ID, LINK_DEST) USING INDEX TABLESPACE $$indexTablespace$$
);
...
CREATE TABLE CMS_SESSIONS (
	...
	CONSTRAINT PK_SESSIONS PRIMARY KEY(SESSION_ID) USING INDEX TABLESPACE $$indexTablespace$$
);
...
CREATE INDEX IDX_SESSIONS_01 
	ON CMS_SESSIONS(SESSION_LASTUSED)
