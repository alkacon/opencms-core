...
CREATE INDEX IDX_SESSIONS_01 ON 			CMS_SESSIONS(SESSION_LASTUSED);
...
CREATE INDEX IDX_OFFLINE_PROPERTIES_01 ON	CMS_OFFLINE_PROPERTIES (PROPERTYDEF_ID, RESOURCE_ID, RESOURCE_NAME);
CREATE INDEX IDX_OFFLINE_PROPERTIES_02 ON	CMS_OFFLINE_PROPERTIES (PROPERTYDEF_ID);

CREATE INDEX IDX_ONLINE_PROPERTIES_01 ON	CMS_ONLINE_PROPERTIES (PROPERTYDEF_ID, RESOURCE_ID, RESOURCE_NAME);
