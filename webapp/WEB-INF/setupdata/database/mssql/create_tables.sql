...
CREATE NONCLUSTERED INDEX CMS_OFFLINE_CONTENTS_01_IDX
    ON CMS_OFFLINE_CONTENTS (HASH, STORAGE);

CREATE NONCLUSTERED INDEX CMS_OFFLINE_CONTENTS_02_IDX
    ON CMS_OFFLINE_CONTENTS (STORAGE, HASH);

CREATE NONCLUSTERED INDEX CMS_CONTENTS_05_IDX
    ON CMS_CONTENTS (HASH, STORAGE);

CREATE NONCLUSTERED INDEX CMS_CONTENTS_07_IDX
