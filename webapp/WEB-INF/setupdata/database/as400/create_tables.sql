CREATE TABLE CMS_USERS ( 
    ...
    USER_NAME VARCHAR(128) CCSID 1208  NOT NULL,
    USER_PASSWORD VARCHAR(255) CCSID 1208  NOT NULL,
    USER_FIRSTNAME VARCHAR(128) CCSID 1208  NOT NULL,
    USER_LASTNAME VARCHAR(128) CCSID 1208  NOT NULL,
    USER_EMAIL VARCHAR(128) CCSID 1208  NOT NULL,
    USER_LASTLOGIN BIGINT NOT NULL,
    USER_FLAGS INT NOT NULL,
    USER_OU VARCHAR(128) CCSID 1208  NOT NULL,
...
CREATE TABLE CMS_USERDATA (
    USER_ID VARCHAR(36) CCSID 1208 NOT NULL,
    DATA_KEY VARCHAR(255) CCSID 1208 NOT NULL,
    DATA_VALUE BLOB(1M),
    DATA_TYPE VARCHAR(128) CCSID 1208 NOT NULL,
...
CREATE TABLE CMS_HISTORY_PRINCIPALS (
    PRINCIPAL_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PRINCIPAL_NAME VARCHAR(128) CCSID 1208 NOT NULL,
    PRINCIPAL_DESCRIPTION VARCHAR(255) CCSID 1208 NOT NULL,
    PRINCIPAL_OU VARCHAR(128) CCSID 1208,
    PRINCIPAL_EMAIL VARCHAR(128) CCSID 1208 NOT NULL,
    PRINCIPAL_TYPE VARCHAR(5) CCSID 1208 NOT NULL,
    PRINCIPAL_USERDELETED VARCHAR(36) CCSID 1208 NOT NULL,
    PRINCIPAL_DATEDELETED BIGINT NOT NULL,
    CONSTRAINT PK_HIST_PRINCIPALS PRIMARY KEY(PRINCIPAL_ID)
);

CREATE TABLE CMS_GROUPS (
    GROUP_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PARENT_GROUP_ID VARCHAR(36) CCSID 1208 NOT NULL,
    GROUP_NAME VARCHAR(128) CCSID 1208 NOT NULL,
    GROUP_DESCRIPTION VARCHAR(255) CCSID 1208 NOT NULL,
    GROUP_FLAGS INT NOT NULL,
    GROUP_OU VARCHAR(128) CCSID 1208 NOT NULL,
...
CREATE TABLE CMS_PROJECTS ( 
    PROJECT_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROJECT_NAME VARCHAR(200) CCSID 1208 NOT NULL,
    PROJECT_DESCRIPTION VARCHAR(255) CCSID 1208 NOT NULL,
    PROJECT_FLAGS INT NOT NULL,
    PROJECT_TYPE INT NOT NULL,
    USER_ID VARCHAR(36) CCSID 1208 NOT NULL,
    GROUP_ID VARCHAR(36) CCSID 1208 NOT NULL,
    MANAGERGROUP_ID VARCHAR(36) CCSID 1208 NOT NULL,
    DATE_CREATED BIGINT NOT NULL,
    PROJECT_OU VARCHAR(128) CCSID 1208 NOT NULL,
...
CREATE TABLE CMS_HISTORY_PROJECTS (
    PROJECT_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROJECT_NAME VARCHAR(255) CCSID 1208 NOT NULL,
    PROJECT_DESCRIPTION VARCHAR(255) CCSID 1208 NOT NULL,
    PROJECT_TYPE INT NOT NULL,
    USER_ID VARCHAR(36) CCSID 1208 NOT NULL,
    GROUP_ID VARCHAR(36) CCSID 1208 NOT NULL,
    ...
    PROJECT_PUBLISHED_BY VARCHAR(36) CCSID 1208 NOT NULL,
    PROJECT_OU VARCHAR(128) CCSID 1208 NOT NULL,
    CONSTRAINT PK_HIST_PRJS PRIMARY KEY(PUBLISH_TAG)
);
 
CREATE TABLE CMS_PROJECTRESOURCES (
    PROJECT_ID VARCHAR(36) CCSID 1208 NOT NULL,
    RESOURCE_PATH VARCHAR(1024) CCSID 1208 NOT NULL,
    CONSTRAINT PK_PRJRESOURCES PRIMARY KEY(PROJECT_ID, RESOURCE_PATH)
);

CREATE INDEX CMS_PRJRES_01_IDX
...
CREATE TABLE CMS_HISTORY_PROJECTRESOURCES (
    ...
    PROJECT_ID VARCHAR(36) CCSID 1208 NOT NULL,
    RESOURCE_PATH VARCHAR(1024) CCSID 1208 NOT NULL,
    CONSTRAINT PK_HIST_PRJRES PRIMARY KEY(PUBLISH_TAG, PROJECT_ID, RESOURCE_PATH)
);

CREATE TABLE CMS_OFFLINE_PROPERTYDEF ( 
    PROPERTYDEF_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROPERTYDEF_NAME VARCHAR(128) CCSID 1208 NOT NULL,
    PROPERTYDEF_TYPE INT NOT NULL,
    CONSTRAINT PK_OFFLINE_PROPDEF PRIMARY KEY(PROPERTYDEF_ID),
    CONSTRAINT UK_OFFLINE_PROPDEF UNIQUE(PROPERTYDEF_NAME)
);
...
CREATE TABLE CMS_ONLINE_PROPERTYDEF ( 
    ...
    PROPERTYDEF_NAME VARCHAR(128) CCSID 1208 NOT NULL,
    PROPERTYDEF_TYPE INT NOT NULL,
    CONSTRAINT PK_ONLINE_PROPDEF PRIMARY KEY(PROPERTYDEF_ID),
    CONSTRAINT UK_ONLINE_PROPDEF UNIQUE(PROPERTYDEF_NAME) 
);
...
CREATE TABLE CMS_HISTORY_PROPERTYDEF ( 
    ...
    PROPERTYDEF_NAME VARCHAR(128) CCSID 1208 NOT NULL,
    PROPERTYDEF_TYPE INT NOT NULL,
    CONSTRAINT PK_HIST_PROPDEF PRIMARY KEY(PROPERTYDEF_ID)
);

CREATE TABLE CMS_OFFLINE_PROPERTIES (
    PROPERTY_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROPERTYDEF_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROPERTY_MAPPING_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROPERTY_MAPPING_TYPE INT NOT NULL,    
    PROPERTY_VALUE VARCHAR(2048) CCSID 1208 NOT NULL,
    CONSTRAINT PK_OFFLINE_PROPS PRIMARY KEY(PROPERTY_ID),
    CONSTRAINT UK_OFFLINE_PROPS UNIQUE(PROPERTYDEF_ID, PROPERTY_MAPPING_ID)
);

CREATE INDEX CMS_OFF_PROPS_01
    ON CMS_OFFLINE_PROPERTIES (PROPERTYDEF_ID);
    
CREATE INDEX CMS_OFF_PROPS_02
...
CREATE TABLE CMS_ONLINE_PROPERTIES (
    ...
    PROPERTY_MAPPING_TYPE INT NOT NULL,    
    PROPERTY_VALUE VARCHAR(2048) CCSID 1208 NOT NULL,
    CONSTRAINT PK_ONLINE_PROPS PRIMARY KEY(PROPERTY_ID),
    CONSTRAINT UK_ONLINE_PROPS UNIQUE(PROPERTYDEF_ID, PROPERTY_MAPPING_ID)
);

CREATE INDEX CMS_ON_PROPS_01
    ON CMS_ONLINE_PROPERTIES (PROPERTYDEF_ID);
    
CREATE INDEX CMS_ON_PROPS_02
    ON CMS_ONLINE_PROPERTIES (PROPERTY_MAPPING_ID);
    
CREATE TABLE CMS_HISTORY_PROPERTIES (
    STRUCTURE_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROPERTYDEF_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROPERTY_MAPPING_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PROPERTY_MAPPING_TYPE INT NOT NULL,    
    PROPERTY_VALUE VARCHAR(2048) CCSID 1208 NOT NULL,
    PUBLISH_TAG INT NOT NULL,
    CONSTRAINT PK_HIST_PROPS PRIMARY KEY(STRUCTURE_ID,PROPERTYDEF_ID,PROPERTY_MAPPING_TYPE,PUBLISH_TAG)
);
...
CREATE TABLE CMS_ONLINE_ACCESSCONTROL (
    ...
    ACCESS_DENIED INT,
    ACCESS_FLAGS INT,
    CONSTRAINT PK_ONLINE_ACE PRIMARY KEY(RESOURCE_ID, PRINCIPAL_ID)
);
...
CREATE TABLE CMS_OFFLINE_ACCESSCONTROL (
    ...
    ACCESS_DENIED INT,
    ACCESS_FLAGS INT,
    CONSTRAINT PK_OFFLINE_ACE PRIMARY KEY(RESOURCE_ID, PRINCIPAL_ID)
);
...
CREATE TABLE CMS_PUBLISH_HISTORY (
    HISTORY_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PUBLISH_TAG INT NOT NULL,
    STRUCTURE_ID VARCHAR(36) CCSID 1208 NOT NULL,
    RESOURCE_ID VARCHAR(36) CCSID 1208 NOT NULL,
    RESOURCE_PATH VARCHAR(1024) CCSID 1208 NOT NULL,
...
CREATE TABLE CMS_PUBLISH_JOBS (
    ...
    PROJECT_NAME VARCHAR(255) CCSID 1208 NOT NULL,
    USER_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PUBLISH_LOCALE VARCHAR(16) CCSID 1208 NOT NULL,
    PUBLISH_FLAGS INT NOT NULL,
    PUBLISH_LIST BLOB(10M),
    PUBLISH_REPORT BLOB(10M),
...
CREATE TABLE CMS_STATICEXPORT_LINKS (
    LINK_ID VARCHAR(36) CCSID 1208 NOT NULL,
    LINK_RFS_PATH VARCHAR(1024) CCSID 1208,
    LINK_TYPE INT NOT NULL,
    LINK_PARAMETER VARCHAR(1024) CCSID 1208,
    LINK_TIMESTAMP BIGINT NOT NULL,
    CONSTRAINT PK_STATICEXP_LINKS PRIMARY KEY (LINK_ID)
);
...
CREATE TABLE CMS_OFFLINE_STRUCTURE (
    STRUCTURE_ID VARCHAR(36) CCSID 1208 NOT NULL,
    RESOURCE_ID VARCHAR(36) CCSID 1208 NOT NULL,
    PARENT_ID VARCHAR(36) CCSID 1208 NOT NULL,
    RESOURCE_PATH VARCHAR(1024) CCSID 1208,
    STRUCTURE_STATE INT NOT NULL,    
    DATE_RELEASED BIGINT NOT NULL,
    DATE_EXPIRED BIGINT NOT NULL,    
    STRUCTURE_VERSION INT NOT NULL,
    CONSTRAINT PK_OFFLINE_STR PRIMARY KEY (STRUCTURE_ID)
);
...
CREATE TABLE CMS_ONLINE_STRUCTURE (
    ...
    DATE_EXPIRED BIGINT NOT NULL,    
    STRUCTURE_VERSION INT NOT NULL,    
    CONSTRAINT PK_ONLINE_STR PRIMARY KEY (STRUCTURE_ID)
);

CREATE INDEX CMS_ONLINE_STR_01_IDX
    ON CMS_ONLINE_STRUCTURE (STRUCTURE_ID, RESOURCE_PATH);
    
CREATE INDEX CMS_ONLINE_STR_02_IDX
    ON CMS_ONLINE_STRUCTURE (RESOURCE_PATH, RESOURCE_ID);
    
CREATE INDEX CMS_ONLINE_STR_03_IDX
    ON CMS_ONLINE_STRUCTURE (STRUCTURE_ID, RESOURCE_ID);
    
CREATE INDEX CMS_ONLINE_STR_04_IDX
    ON CMS_ONLINE_STRUCTURE (STRUCTURE_STATE);
    
CREATE INDEX CMS_ONLINE_STR_05_IDX
    ON CMS_ONLINE_STRUCTURE (PARENT_ID);
    
CREATE INDEX CMS_ONLINE_STR_06_IDX
    ON CMS_ONLINE_STRUCTURE (RESOURCE_ID);
    
CREATE INDEX CMS_ONLINE_STR_07_IDX
...
CREATE TABLE CMS_OFFLINE_RESOURCES (
    ...
    USER_CREATED VARCHAR(36) CCSID 1208 NOT NULL,
    USER_LASTMODIFIED VARCHAR(36) CCSID 1208 NOT NULL,
    PROJECT_LASTMODIFIED VARCHAR(36) CCSID 1208 NOT NULL,
    RESOURCE_VERSION INT NOT NULL,
    CONSTRAINT PK_OFFLINE_RES PRIMARY KEY(RESOURCE_ID)
);

CREATE INDEX CMS_OFFLINE_RES_01
    ON CMS_OFFLINE_RESOURCES (PROJECT_LASTMODIFIED);

CREATE INDEX CMS_OFFLINE_RES_02
    ON CMS_OFFLINE_RESOURCES (PROJECT_LASTMODIFIED, RESOURCE_SIZE);

CREATE INDEX CMS_OFFLINE_RES_03
    ON CMS_OFFLINE_RESOURCES (RESOURCE_SIZE);
    
CREATE INDEX CMS_OFFLINE_RES_04
    ON CMS_OFFLINE_RESOURCES (DATE_LASTMODIFIED);
    
CREATE INDEX CMS_OFFLINE_RES_05
...
CREATE TABLE CMS_ONLINE_RESOURCES (
    ...
    PROJECT_LASTMODIFIED VARCHAR(36) CCSID 1208 NOT NULL,
    RESOURCE_VERSION INT NOT NULL,
    CONSTRAINT PK_ONLINE_RES PRIMARY KEY(RESOURCE_ID)
);

CREATE INDEX CMS_ONLINE_RES_01
    ON CMS_ONLINE_RESOURCES (PROJECT_LASTMODIFIED);

CREATE INDEX CMS_ONLINE_RES_02
    ON CMS_ONLINE_RESOURCES (PROJECT_LASTMODIFIED, RESOURCE_SIZE);

CREATE INDEX CMS_ONLINE_RES_03
    ON CMS_ONLINE_RESOURCES (RESOURCE_SIZE);
    
CREATE INDEX CMS_ONLINE_RES_04
    ON CMS_ONLINE_RESOURCES (DATE_LASTMODIFIED);
    
CREATE INDEX CMS_ONLINE_RES_05
...
CREATE TABLE CMS_OFFLINE_CONTENTS (
    RESOURCE_ID VARCHAR(36) CCSID 1208 NOT NULL,
    FILE_CONTENT BLOB(50M) NOT NULL,
    STORAGE VARCHAR(32) CCSID 1208,
    HASH VARCHAR(128) CCSID 1208,
    CONSTRAINT PK_OFFLINE_CNT PRIMARY KEY(RESOURCE_ID)
);
...
CREATE TABLE CMS_CONTENTS (
    ...
    PUBLISH_TAG_TO INT NOT NULL,
    ONLINE_FLAG INT NOT NULL,
    CONSTRAINT PK_CONTENTS PRIMARY KEY(RESOURCE_ID, PUBLISH_TAG_FROM)
);

CREATE INDEX CMS_CONTENTS_01
    ON CMS_CONTENTS (RESOURCE_ID, PUBLISH_TAG_TO);
    
CREATE INDEX CMS_CONTENTS_02
    ON CMS_CONTENTS (RESOURCE_ID);
    
CREATE INDEX CMS_CONTENTS_03
    ON CMS_CONTENTS (PUBLISH_TAG_FROM);
    
CREATE INDEX CMS_CONTENTS_04
    ON CMS_CONTENTS (PUBLISH_TAG_TO);
    
CREATE INDEX CMS_CONTENTS_05
    ON CMS_CONTENTS (RESOURCE_ID, ONLINE_FLAG);

CREATE INDEX CMS_OFFLINE_CONTENTS_01
    ON CMS_OFFLINE_CONTENTS (HASH, STORAGE);

CREATE INDEX CMS_OFFLINE_CONTENTS_02
    ON CMS_OFFLINE_CONTENTS (STORAGE, HASH);

CREATE INDEX CMS_CONTENTS_06
    ON CMS_CONTENTS (HASH, STORAGE);

CREATE INDEX CMS_CONTENTS_07
    ON CMS_CONTENTS (STORAGE, HASH);

CREATE TABLE CMS_ONLINE_RESOURCE_RELATIONS (
    RELATION_SOURCE_ID VARCHAR(36) CCSID 1208 NOT NULL,
    RELATION_SOURCE_PATH VARCHAR(1024) CCSID 1208 NOT NULL,
    RELATION_TARGET_ID VARCHAR(36) CCSID 1208 NOT NULL,
    RELATION_TARGET_PATH VARCHAR(1024) CCSID 1208 NOT NULL,
...
CREATE TABLE CMS_LOG (
    ...
    LOG_DATA VARCHAR(1024) CCSID 1208,
...
CREATE TABLE CMS_SUBSCRIPTION_VISIT (
    ...
    STRUCTURE_ID VARCHAR(36) CCSID 1208,
...
CREATE TABLE CMS_OFFLINE_URLNAME_MAPPINGS (
	NAME VARCHAR(255) CCSID 1208 NOT NULL,
