...
%><%	     
    ...
    editLink += "?resource=" + editTarget + "&directedit=true&bodylanguage=en&bodyname=" + editBody;
%>

<cms:template element="start_editarea_enabled">
<!-- EDIT BLOCK START -->
<table border="0" cellpadding="0" cellspacing="0"> 
<tr><td id="editarea_<%=editBody%>" class="editarea_norm">
<div class="editbutton" onmouseover="activate('editarea_<%=editBody%>');" onmouseout="deactivate('editarea_<%=editBody%>');">
