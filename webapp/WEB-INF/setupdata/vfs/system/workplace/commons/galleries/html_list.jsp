...
%><%= wp.htmlStart(null) %>
	...
	<!--
		function validateGalleryPath() {
			...
			top.gallery_preview.location.href="galleries/html_preview.jsp?resourcepath="+top.gallery_fs.gallery_head.previewUri;			
		}
		
		function preview(uri) {
			top.gallery_fs.gallery_head.previewUri = uri;
			top.gallery_preview.location.href="html_preview.jsp?resourcepath="+uri;			
		}												
	//-->
	</script>
</head>
