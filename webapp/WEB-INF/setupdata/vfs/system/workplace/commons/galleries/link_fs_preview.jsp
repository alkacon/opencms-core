...
<frameset rows="25,*" border="0" frameborder="0" framespacing="0">
    <frame <%= wp.getFrameSource("gallery_buttonbar", cms.link("link_buttonbar.jsp" + params)) %> noresize="noresize" scrolling="no" style="border-top: 1px solid WindowFrame;">
    <frame <%= wp.getFrameSource("gallery_preview", cms.link("link_preview.jsp" + params)) %> scrolling="auto">
</frameset>
