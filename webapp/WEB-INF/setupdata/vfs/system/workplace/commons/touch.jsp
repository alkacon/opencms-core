...
<tr>
	...
	<td>&nbsp;<img src="<%= wp.getResourceUri() %>ic_timer.gif" id="triggernewreleasedate" alt="<%= wp.key("calendar.input.choosedate") %>" title="<%=  wp.key("calendar.input.choosedate") %>" border="0"></td>
</tr>
<tr>
	...
	<td>&nbsp;<img src="<%= wp.getResourceUri() %>ic_timer.gif" id="triggernewexpiredate" alt="<%= wp.key("calendar.input.choosedate") %>" title="<%=  wp.key("calendar.input.choosedate") %>" border="0"></td>
</tr>
