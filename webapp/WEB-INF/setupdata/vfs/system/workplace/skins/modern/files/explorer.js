...
function printList(wo) {
	...
	+ "</script>"
	+ "<style type='text/css'>\n"
	+ "body { font-family: verdana, sans-serif; font-size: 11px; padding: 0px; margin: 0px; backgound-color: #ffffff; } "
	+ "p, td { font-family: verdana, sans-serif; font-size: 11px; white-space: nowrap; } "
	+ "td.t { white-space: nowrap; background:#c0c0c0; border-right: 1px solid #666666; border-top: 1px solid #ffffff; border-bottom: 1px solid #666666; border-left: 1px solid #ffffff; } "
	+ "td.t125 { white-space: nowrap; width: 125px; background:#c0c0c0; border-right: 1px solid #666666; border-top: 1px solid #ffffff; border-bottom: 1px solid #666666; border-left: 1px solid #ffffff; } "
	+ "td.t100 { white-space: nowrap; width: 100px; background:#c0c0c0; border-right: 1px solid #666666; border-top: 1px solid #ffffff; border-bottom: 1px solid #666666; border-left: 1px solid #ffffff; } "
	+ "td.t75 { white-space: nowrap; width: 75px; background:#c0c0c0; border-right: 1px solid #666666; border-top: 1px solid #ffffff; border-bottom: 1px solid #666666; border-left: 1px solid #ffffff; } "
	...
	+ "div.cm { position: absolute; visibility: hidden; top: 0px; left: 0px; background-color: #c0c0c0; z-index: 100; border-left: 1px solid #c0c0c0; border-top: 1px solid #c0c0c0; border-bottom: 1px solid #000000; border-right: 1px solid #000000; filter:progid:DXImageTransform.Microsoft.Shadow(color=#666666, Direction=135, Strength=3); } "
	+ "div.cm2 { border-left: 1px solid #ffffff; border-top: 1px solid #ffffff; border-bottom: 1px solid #888888; border-right: 1px solid #888888; } "
	+ "table.cm { width: 150px; } "
	+ "span.cmsep { display: block; width: 100%; height: 1px; font-size: 0px; background-color: #888888; padding: 0px; border-bottom: 1px solid #ffffff;} "
	+ "td.cmsep { padding: 2px; } "
	+ "a.cme { color: #000000; text-decoration: none;} "
	+ "span.cmenorm { cursor: hand; display: block; height: 16px; width: 100%; padding-left: 10px; padding-top: 2px; } "
	+ "span.cmehigh { cursor: hand; display: block; height: 16px; width: 100%; padding-left: 10px; padding-top: 2px; color:#ffffff; background-color:#000088; } "
	+ "span.inanorm { cursor: hand; display: block; height: 16px; width: 100%; padding-left: 10px; padding-top: 2px; color:#888888; } "
	+ "span.inahigh { cursor: hand; display: block; height: 16px; width: 100%; padding-left: 10px; padding-top: 2px; color:#888888; background-color:#000088; } "

	+ ".selected { background:#000088; color:#ffffff; } "
	+ ".unselected { background:#ffffff; color:#000000; } "
	...
	if ((openfolderMethod != "openthisfolderflat") && (mode != "projectview")) {
		var pos = returnplace.indexOf("/jsp/dialogs/");
		if (pos >= 0) {
			returnplace = returnplace.substring(0, pos + 5) + returnplace.substring(pos + 13);
			var pos2 = returnplace.indexOf("?");
			if (pos2 < 0) {
				pos2 = returnplace.length + 1;
			}
			var loc = returnplace.substring(0, pos2 - 1);
			loc = loc.substring(0, loc.lastIndexOf("/")) + "/explorer_files.html";
...
function openurl() {
	...
	win.files.location = vr.servpath + "/system/workplace/jsp/explorer_files.html?resource=" + getDisplayResource() + selectedpage;
}
...
function displayHead(doc, pages, actpage){
	...
	+ "<link rel=\"stylesheet\" type=\"text/css\" href=\"" + vi.skinPath + "files/css_workplace.css\"></link>\n"
