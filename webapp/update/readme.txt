            ...
            Instructions for updating OpenCms 6.x/7.x to OpenCms 7.5.1
...
Follow the following steps to update from OpenCms 6.x/7.x to OpenCms 7.5.1:
...
2. Extract the OpenCms upgrade file 'opencms_upgrade_to_7.5.1.zip' to 
