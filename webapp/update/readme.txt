            ...
            Instructions for updating OpenCms 7.x and 8.0.0 to OpenCms 8.0.1
...
Follow the following steps to update from OpenCms 7.x and 8.0.0 to OpenCms 8.0.1:
...
2. Extract the OpenCms upgrade file 'opencms_upgrade_to_8.0.1.zip' to 
