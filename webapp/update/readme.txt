            ...
            Instructions for updating OpenCms 7.x and 8.0.x to OpenCms 8.5.0
...
Follow the following steps to update from OpenCms 7.x and 8.0.x to OpenCms 8.5.0:
...
2. Extract the OpenCms upgrade file 'opencms_upgrade_to_8.5.0.zip' to 
