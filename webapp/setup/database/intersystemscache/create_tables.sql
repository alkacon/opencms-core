...
CREATE TABLE CMS_USER_PUBLISH_LIST (STRUCTURE_ID VARCHAR(36) NOT NULL, USER_ID VARCHAR(36) NOT NULL, DATE_CHANGED NUMERIC NOT NULL, PRIMARY KEY (STRUCTURE_ID, USER_ID));
