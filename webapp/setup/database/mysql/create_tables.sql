...
CREATE TABLE CMS_LOG (
    ...
    UNIQUE INDEX USER_RESOURCE_IDX (USER_ID, LOG_DATE, RESOURCE_ID, LOG_TYPE),
    INDEX CMS_LOG_01_IDX (USER_ID),
    INDEX CMS_LOG_02_IDX (RESOURCE_ID),
    INDEX CMS_LOG_03_IDX (LOG_DATE),
    INDEX CMS_LOG_04_IDX (LOG_TYPE),
    INDEX CMS_LOG_05_IDX (USER_ID, RESOURCE_ID),
    INDEX CMS_LOG_06_IDX (USER_ID, LOG_DATE),
    INDEX CMS_LOG_07_IDX (USER_ID, RESOURCE_ID, LOG_DATE)
);
