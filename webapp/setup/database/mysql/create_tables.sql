...
CREATE TABLE CMS_GROUPUSERS (
    ...
    UNIQUE INDEX GROUPUSERS_IDX (GROUP_ID, USER_ID),
...
CREATE TABLE CMS_PROJECTRESOURCES (
    ...
    UNIQUE INDEX PROJECTRESOURCES_IDX (PROJECT_ID, RESOURCE_PATH(255)),
...
CREATE TABLE CMS_HISTORY_PROJECTRESOURCES (
    ...
    PROJECT_ID VARCHAR(36) NOT NULL,
    RESOURCE_PATH BLOB NOT NULL,
    UNIQUE INDEX HISTORY_PROJECTRESOURCES_IDX (PUBLISH_TAG, PROJECT_ID, RESOURCE_PATH(255))
);
...
CREATE TABLE CMS_HISTORY_PROPERTIES (
    ...
    PROPERTY_VALUE BLOB NOT NULL,
    PUBLISH_TAG INT,
    UNIQUE INDEX HISTORY_PROPERTIES_IDX (STRUCTURE_ID,PROPERTYDEF_ID,PROPERTY_MAPPING_TYPE,PUBLISH_TAG),
    INDEX PROPERTYDEF_ID_IDX (PROPERTYDEF_ID),
    INDEX PROPERTY_MAPPING_ID_IDX (PROPERTY_MAPPING_ID),    
...
CREATE TABLE CMS_ONLINE_ACCESSCONTROL (
    ...
    ACCESS_DENIED INT,
    ACCESS_FLAGS INT,
    UNIQUE INDEX ONLINE_ACCESSCONTROL_IDX (RESOURCE_ID, PRINCIPAL_ID),
...
CREATE TABLE CMS_OFFLINE_ACCESSCONTROL (
    ...
    ACCESS_DENIED INT,
    ACCESS_FLAGS INT,
    UNIQUE INDEX OFFLINE_ACCESSCONTROL_IDX (RESOURCE_ID, PRINCIPAL_ID),
    INDEX PRINCIPAL_ID_IDX (PRINCIPAL_ID),
    INDEX RESOURCE_ID_IDX (RESOURCE_ID)
);
...
CREATE TABLE CMS_PUBLISH_HISTORY (
    ...
    UNIQUE INDEX PUBLISH_HISTORY_IDX (HISTORY_ID, PUBLISH_TAG, STRUCTURE_ID, RESOURCE_PATH(255)),
...
CREATE TABLE CMS_HISTORY_STRUCTURE (
    ...
    DATE_EXPIRED BIGINT NOT NULL,
    STRUCTURE_VERSION INT NOT NULL,
    UNIQUE INDEX HISTORY_STRUCTURE_IDX (STRUCTURE_ID,PUBLISH_TAG,VERSION),
...
CREATE TABLE CMS_HISTORY_RESOURCES (
    ...
    PUBLISH_TAG INT NOT NULL,
    RESOURCE_VERSION INT NOT NULL,
    UNIQUE INDEX HISTORY_RESOURCES_IDX (RESOURCE_ID,PUBLISH_TAG),
    INDEX RESOURCE_ID_IDX (RESOURCE_ID),
    INDEX PUBLISH_TAG_IDX (PUBLISH_TAG)
);
...
CREATE TABLE CMS_CONTENTS (
    ...
    PUBLISH_TAG_TO INT,
    ONLINE_FLAG INT,
    UNIQUE INDEX CONTENTS_PRIMARY_IDX (RESOURCE_ID, PUBLISH_TAG_FROM),
