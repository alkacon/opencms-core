...
CREATE TABLE CMS_USER_PUBLISH_LIST -- CmsDAOUserPublishListEntry
    (STRUCTURE_ID VARCHAR(36) NOT NULL, USER_ID VARCHAR(36) NOT NULL, DATE_CHANGED BIGINT NOT NULL, PRIMARY KEY (STRUCTURE_ID, USER_ID));
...
CREATE TABLE CMS_REWRITES -- CmsDAORewriteAlias
    (ID VARCHAR(36) NOT NULL, ALIAS_MODE INTEGER NOT NULL, PATTERN VARCHAR(255) NOT NULL, REPLACEMENT VARCHAR(255) NOT NULL, SITE_ROOT VARCHAR(64) NOT NULL, PRIMARY KEY (ID));
