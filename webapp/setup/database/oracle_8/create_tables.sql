...
CREATE TABLE CMS_ONLINE_CONTENTS (
    RESOURCE_ID VARCHAR2(36) NOT NULL,
    FILE_CONTENT BLOB NOT NULL,
    CONSTRAINT PK_ONLINE_CONTENTS PRIMARY KEY(RESOURCE_ID) USING INDEX TABLESPACE ${indexTablespace}
)
STORAGE (INITIAL 256K NEXT 1M PCTINCREASE 0)
    LOB(FILE_CONTENT) STORE AS (
        CHUNK 32K PCTVERSION 20  
...
CREATE TABLE CMS_LOG (
    ...
    CONSTRAINT PK_LOG PRIMARY KEY(USER_ID, LOG_DATE, LOG_TYPE) USING INDEX TABLESPACE ${indexTablespace},
    CONSTRAINT UK_LOG UNIQUE(USER_ID, LOG_DATE, RESOURCE_ID, LOG_TYPE) USING INDEX TABLESPACE ${indexTablespace}
);
