...
CREATE INDEX IDX_ONLINE_ACCESSCONTROL_01
...
CREATE INDEX IDX_OFFLINE_ACCESSCONTROL_01
...
CREATE INDEX IDX_CMS_PUBLISH_HISTORY_01
...
CREATE INDEX IDX_CMS_BACKUP_STRUCTURE_06
...
CREATE INDEX IDX_CMS_BACKUP_STRUCTURE_08
...
CREATE INDEX IDX_CMS_BACKUP_RESOURCES_06
	ON CMS_BACKUP_RESOURCES (RESOURCE_ID)
	TABLESPACE ${indexTablespace};

CREATE INDEX IDX_CMS_BACKUP_RESOURCES_07
...
CREATE TABLE CMS_BACKUP_CONTENTS (
	...
	CONSTRAINT UK_BACKUP_CONTENTS UNIQUE(RESOURCE_ID) USING INDEX TABLESPACE ${indexTablespace}
)	
STORAGE (INITIAL 256K NEXT 1M PCTINCREASE 0)
	LOB(FILE_CONTENT) STORE AS (
        CHUNK 32K PCTVERSION 20  
