...
--%><jsp:setProperty name="Bean" property="*" /><%
    ...
    boolean isFormSubmitted = Bean.setDbParamaters(request, CmsSetupBean.MARIADB_PROVIDER);
...
Enter the name of the MariaDB <b>Database</b> which should be used by Alkacon OpenCms.
<%= Bean.getHtmlPart("C_HELP_END") %>

<%= Bean.getHtmlPart("C_HELP_START", "5") %>
The setup wizard <b>creates</b> the MariaDB database and the tables for Alkacon OpenCms.<br>&nbsp;<br>
...
<b>MariaDB 4.1 configuration notes:</b><br>&nbsp;<br>
MariaDB limits the size of packets which can be stored in the database. 
In order to increase the maximum file size for Alkacon OpenCms, 
you have to adjust this setting for MariaDB.<br>&nbsp;<br>
