...
<b>DB2 v9 configuration notes:</b><br>&nbsp;<br>
DB2 uses the Operative System users, so be sure to create the user before continuing.<br>&nbsp;<br>
The Setup Wizard does not create the database, so please create it before continuing, using a statement like <code>CREATE DATABASE ${database} USING CODESET UTF-8 TERRITORY DE PAGESIZE 32 K;</code>.
<%= Bean.getHtmlPart("C_HELP_END") %>
