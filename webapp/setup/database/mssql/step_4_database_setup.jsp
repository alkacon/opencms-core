...
Enter the name of the MS SQL <b>Database</b> which should be used by OpenCms.
<%= Bean.getHtmlPart("C_HELP_END") %>

<%= Bean.getHtmlPart("C_HELP_START", "5") %>
The setup wizard <b>creates</b> the MS SQL database and the tables for OpenCms.<br>&nbsp;<br>
