...
PACKAGE opencmsConstants IS
  ...
  C_TABLE_SYSTEMPROPERTIES VARCHAR2(32) := 'CMS_SYSTEMPROPERTIES';
  C_TABLE_GROUPS VARCHAR2(32) := 'CMS_GROUPS';
  C_TABLE_GROUPUSERS VARCHAR2(32) := 'CMS_GROUPUSERS';
  C_TABLE_USERS VARCHAR2(32) := 'CMS_USERS';
  C_TABLE_PROJECTS VARCHAR2(32) := 'CMS_PROJECTS';
  C_TABLE_RESOURCES VARCHAR2(32) := 'CMS_RESOURCES';
  C_TABLE_FILES VARCHAR2(32) := 'CMS_FILES';
  C_TABLE_PROPERTYDEF VARCHAR2(32) := 'CMS_PROPERTYDEF';
  C_TABLE_PROPERTIES VARCHAR2(32) := 'CMS_PROPERTIES';
  C_TABLE_TASK VARCHAR2(32) := 'CMS_TASKS';
  C_TABLE_TASKTYPE VARCHAR2(32) := 'CMS_TASKTYPE';
  C_TABLE_TASKPAR VARCHAR2(32) := 'CMS_TASKPAR';
  C_TABLE_TASKLOG VARCHAR2(32) := 'CMS_TASKLOG';
  ...
  C_PROJECT_STATE_INVISIBLE NUMBER := 3;
