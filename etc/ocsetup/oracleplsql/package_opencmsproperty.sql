...
PACKAGE opencmsProperty IS
  ...
  PROCEDURE writeProperties(pProjectId IN NUMBER, pPropertyInfo IN userTypes.anyCursor, pResourceId IN NUMBER, pResourceType IN NUMBER);
  PROCEDURE writeProperty(pProjectId IN NUMBER, pMeta IN VARCHAR2, pValue IN VARCHAR2, pResourceId IN NUMBER, pResourceType IN NUMBER);
END;
/
