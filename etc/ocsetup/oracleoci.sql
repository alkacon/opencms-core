...
CREATE INDEX IDX2 ON CMS_OFFLINE_RESOURCES (STATE);

CREATE INDEX IDX3 ON CMS_OFFLINE_RESOURCES (PROJECT_ID, RESOURCE_TYPE);

CREATE INDEX IDX4 ON CMS_OFFLINE_RESOURCES (RESOURCE_ID, PROJECT_ID);

CREATE INDEX IDX5 ON CMS_OFFLINE_RESOURCES(FILE_ID);

CREATE INDEX IDX6 ON CMS_OFFLINE_RESOURCES(GROUP_ID);

CREATE INDEX IDX7 ON CMS_OFFLINE_RESOURCES(LOCKED_BY);

CREATE INDEX IDX8 ON CMS_OFFLINE_RESOURCES(PARENT_ID);

CREATE INDEX IDX9 ON CMS_OFFLINE_RESOURCES(PROJECT_ID);

CREATE INDEX IDX10 ON CMS_OFFLINE_RESOURCES(USER_ID);

CREATE INDEX IDX11 ON CMS_OFFLINE_RESOURCES(PARENT_ID, RESOURCE_TYPE);
  
  
  
CREATE INDEX IDX12 ON CMS_ONLINE_RESOURCES (RESOURCE_TYPE);

CREATE INDEX IDX13 ON CMS_ONLINE_RESOURCES (STATE);

CREATE INDEX IDX14 ON CMS_ONLINE_RESOURCES (PROJECT_ID, RESOURCE_TYPE);

CREATE INDEX IDX15 ON CMS_ONLINE_RESOURCES (RESOURCE_ID, PROJECT_ID);

CREATE INDEX IDX16 ON CMS_ONLINE_RESOURCES(FILE_ID);

CREATE INDEX IDX17 ON CMS_ONLINE_RESOURCES(GROUP_ID);

CREATE INDEX IDX18 ON CMS_ONLINE_RESOURCES(LOCKED_BY);

CREATE INDEX IDX19 ON CMS_ONLINE_RESOURCES(PARENT_ID);

CREATE INDEX IDX20 ON CMS_ONLINE_RESOURCES(PROJECT_ID);

CREATE INDEX IDX21 ON CMS_ONLINE_RESOURCES(USER_ID);

CREATE INDEX IDX22 ON CMS_ONLINE_RESOURCES(PARENT_ID, RESOURCE_TYPE);
