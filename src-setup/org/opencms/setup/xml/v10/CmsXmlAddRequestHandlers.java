...
/**
 * Adds the new init resource handler classes, from 9.5.x to 10.0.0.<p>
 *
 * @since 8.0.0
 */
public class CmsXmlAddRequestHandlers extends A_CmsSetupXmlUpdate {
    ...
    public String getName() {
        ...
        return "Add new request handler classes";
    }
    ...
    protected List<String> getXPathsToUpdate() {
        ...
        if (m_xpaths == null) {
            String[] handlers = new String[] {
                CmsStaticResourceHandler.class.getName(),
                OpenCmsSolrHandler.class.getName(),
                OpenCmsSpellcheckHandler.class.getName()};
