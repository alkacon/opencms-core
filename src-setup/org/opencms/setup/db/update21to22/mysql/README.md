# Manual Storage Schema Update for MySQL / MariaDB
...
ALTER TABLE CMS_CONTENTS ADD COLUMN STORAGE VARCHAR(32) BINARY;
ALTER TABLE CMS_CONTENTS ADD COLUMN HASH VARCHAR(128) BINARY;
CREATE INDEX HASH_IDX ON CMS_CONTENTS (HASH, STORAGE);
CREATE INDEX STORAGE_IDX ON CMS_CONTENTS (STORAGE, HASH);

ALTER TABLE CMS_OFFLINE_CONTENTS ADD COLUMN STORAGE VARCHAR(32) BINARY;
ALTER TABLE CMS_OFFLINE_CONTENTS ADD COLUMN HASH VARCHAR(128) BINARY;
CREATE INDEX HASH_IDX ON CMS_OFFLINE_CONTENTS (HASH, STORAGE);
CREATE INDEX STORAGE_IDX ON CMS_OFFLINE_CONTENTS (STORAGE, HASH);
```
