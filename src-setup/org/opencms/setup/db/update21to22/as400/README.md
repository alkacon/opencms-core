# Manual Storage Schema Update for AS/400
...
ALTER TABLE CMS_CONTENTS ADD COLUMN STORAGE VARCHAR(32) CCSID 1208;
ALTER TABLE CMS_CONTENTS ADD COLUMN HASH VARCHAR(128) CCSID 1208;
CREATE INDEX CMS_CONTENTS_06 ON CMS_CONTENTS (HASH, STORAGE);
CREATE INDEX CMS_CONTENTS_07 ON CMS_CONTENTS (STORAGE, HASH);

ALTER TABLE CMS_OFFLINE_CONTENTS ADD COLUMN STORAGE VARCHAR(32) CCSID 1208;
ALTER TABLE CMS_OFFLINE_CONTENTS ADD COLUMN HASH VARCHAR(128) CCSID 1208;
