...
import org.opencms.acacia.client.UndoRedoHandler.ChangeType;
...
public class AttributeHandler extends RootHandler {
    ...
    public void addNewAttributeValue(Entity value) {
        ...
        if (mayHaveMore && value.getTypeName().equals(m_attributeType)) {
            ...
            if ((m_attributeValueViews.size() == 1) && !m_attributeValueViews.get(0).hasValue()) {
                ...
                valueView = new AttributeValueView(
                    this,
                    m_widgetService.getAttributeLabel(m_attributeName),
                    m_widgetService.getAttributeHelp(m_attributeName));
            }
    ...
    /**
     * @see org.opencms.acacia.client.RootHandler#collectSimplePath(org.opencms.acacia.client.I_AttributeHandler)
     */
    @Override
    ...
    public CmsDNDHandler getDNDHandler() {
        ...
        if (m_dndHandler == null) {
            m_dndHandler = new CmsDNDHandler(new AttributeDNDController());
    ...
    /**
     * @see org.opencms.acacia.client.RootHandler#setHandlerById(java.lang.String, org.opencms.acacia.client.AttributeHandler)
     */
    @Override
