...
public class EditorBase implements I_InlineHtmlUpdateHandler {
    ...
    public EditorBase(I_ContentServiceAsync service, I_WidgetService widgetService) {
        ...
        org.opencms.acacia.client.css.I_LayoutBundle.INSTANCE.form().ensureInjected();
        org.opencms.acacia.client.css.I_LayoutBundle.INSTANCE.attributeChoice().ensureInjected();
        m_service = service;
    ...
    /**
     * @see org.opencms.acacia.client.I_InlineHtmlUpdateHandler#reinitWidgets(org.opencms.acacia.client.I_InlineFormParent)
     */
    ...
    /**
    * @see org.opencms.acacia.client.I_InlineHtmlUpdateHandler#updateHtml(org.opencms.acacia.client.I_InlineFormParent, com.google.gwt.user.client.Command)
    */
     ...
     */
    protected RootHandler getRootAttributeHandler() {
