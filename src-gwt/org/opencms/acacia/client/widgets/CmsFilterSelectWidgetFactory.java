 ...
 */
public class CmsFilterSelectWidgetFactory implements I_CmsWidgetFactory, I_CmsHasInit {

    /** The widget name. */
    private static final String WIDGET_NAME = "org.opencms.widgets.CmsFilterSelectWidget";
    ...
    public static void initClass() {
        ...
        WidgetRegistry.getInstance().registerWidgetFactory(WIDGET_NAME, new CmsFilterSelectWidgetFactory());
    ...
    public I_CmsFormEditWidget createFormWidget(String configuration) {
        ...
        return new CmsFormWidgetWrapper(new CmsFilterSelectWidget(configuration));
    }
