...
public final class TinyMCEWidget extends A_EditWidget implements HasResizeHandlers {
    ...
    /**
     * @see org.opencms.acacia.client.widgets.A_EditWidget#addValueChangeHandler(com.google.gwt.event.logical.shared.ValueChangeHandler)
     */
    @Override
    ...
    protected native void refocusInlineEditor() /*-{
                                                ...
                                                .getElementById(this.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_id);
                                                elem.blur();
                                                elem.focus();
                                                }-*/;
    ...
    protected native void removeEditor() /*-{
                                         var editor = this.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_editor;
                                         editor.remove();
                                         }-*/;
    ...
    protected native void setMainElementContent(String html) /*-{
                                                             var instance = this;
                                                             var elementId = instance.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_id;
    ...
    native void initNative() /*-{
                             ...
                             var mainElement = $wnd.document.getElementById(elementId);
                             var editorHeight = self.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_editorHeight
                             + "px";

                             var fireChange = function() {
                             self.@org.opencms.acacia.client.widgets.TinyMCEWidget::fireChangeFromNative()();
                             };
                             var options = this.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_options;
                             ...
                             self.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_currentContent = mainElement.innerHTML;
                             defaults.inline = true;
                             defaults.width = this.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_width;
                             var toolbarContainer = $wnd.document.createElement("div");
                             toolbarContainer.className = @org.opencms.acacia.client.widgets.TinyMCEWidget::TOOLBAR_CONTAINER;
                             ...
                             this.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_toolbarContainer = toolbarContainer;
                             defaults.fixed_toolbar_container = "#" + elementId
                             + "_toolbarContainer";
                             } else {
                             self.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_currentContent = self.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_originalContent;
                             ...
                             self.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_editor = ed;
                             ...
                             'LoadContent',
                             function() {
                                if (!self.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_inline) {
                                    ...
                                    ed.dom
                                            .bind(
                                                    ...
                                                    'resize',
                                                    function() {
                                                        self.@org.opencms.acacia.client.widgets.TinyMCEWidget::fireResizeEvent()();
                                                    });
                                    var content = self.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_originalContent;
                                    if (content != null) {
                                ...
                                self.@org.opencms.acacia.client.widgets.TinyMCEWidget::m_initialized = true;
                             });
                             ...
                             .on(
                                'Click',
                                function(event) {
                                    self.@org.opencms.acacia.client.widgets.TinyMCEWidget::propagateFocusEvent()();
                                });
                             ed
                             .on(
                                'activate',
                             ...
                             .on(
                                    'init',
                                    function() {
                                        self.@org.opencms.acacia.client.widgets.TinyMCEWidget::scheduleRefocus()();
                                    });
                             }
                             ed
                             .on(
                                'focus',
                                function(event) {
                                    self.@org.opencms.acacia.client.widgets.TinyMCEWidget::resetToolbarContainerPosition()();
                                });
                             }
                             };
                             // set default z-index for overlay ui components
                             var cssConstants = @org.opencms.acacia.client.css.I_LayoutBundle::INSTANCE.@org.opencms.acacia.client.css.I_LayoutBundle::constants()().@org.opencms.gwt.client.ui.css.I_CmsConstantsBundle::css()();
