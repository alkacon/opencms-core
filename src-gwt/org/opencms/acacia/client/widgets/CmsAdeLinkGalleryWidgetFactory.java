...
public class CmsAdeLinkGalleryWidgetFactory implements I_CmsWidgetFactory, I_CmsHasInit {

    /** The widget name. */
    private static final String WIDGET_NAME = CmsGwtConstants.WIDGET_LINKGALLERY;
