...
public final class CmsSliderMap extends HTML {
    ...
    public CmsSliderMap(CmsColorPicker parent) {
        ...
        getElement().getStyle().setBorderColor("back");
    ...
    public void onAttach() {
        ...
        m_slider.getElement().getStyle().setTop(7, Unit.PX);
        m_slider.getElement().getStyle().setLeft(7, Unit.PX);
        ...
        switch (DOM.eventGetType(event)) {
            ...
            case Event.ONMOUSEMOVE:
                if (m_capturedMouse) {
                    ...
                    int x = (event.getClientX() - m_colorUnderlay.getAbsoluteLeft()) + 1 + Window.getScrollLeft();
                    int y = (event.getClientY() - m_colorUnderlay.getAbsoluteTop()) + 1 + Window.getScrollTop();
