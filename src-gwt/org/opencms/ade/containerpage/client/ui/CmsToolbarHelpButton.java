 ...
 */
public class CmsToolbarHelpButton extends A_CmsToolbarOptionButton {
     ...
     */
    public CmsToolbarHelpButton(CmsContainerpageHandler handler) {

        super(I_CmsButton.ButtonData.RESOURCE_HELP, handler);
    }
    ...
    public boolean isOptionAvailable(CmsContainerPageElementPanel element) {
        ...
        try {
            return CmsCoreProvider.get().isHelpDialogAvailable(element.getStructureId());
        } catch (Throwable t) {
            return false;
        }
    }
    ...
    public void onElementClick(ClickEvent event, CmsContainerPageElementPanel element) {
        ...
        getHandler().openHelpDialog(element, CmsResourceHelpDialogType.RESOURCE);
    }
