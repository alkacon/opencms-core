...
public final class NativeEditWidget extends JavaScriptObject {
    ...
    public static native NativeEditWidget wrapWidget(I_EditWidget widget)/*-{
                                                                         ...
                                                                         return this.instance.@org.opencms.acacia.client.widgets.I_EditWidget::asWidget()().@com.google.gwt.user.client.ui.Widget::getElement()();
                                                                         }
                                                                         nat.isActive = function() {
                                                                         return this.instance.@org.opencms.acacia.client.widgets.I_EditWidget::isActive()();
                                                                         }
                                                                         nat.setActive = function(active) {
                                                                         return this.instance.@org.opencms.acacia.client.widgets.I_EditWidget::setActive(Z)(active);
                                                                         }
                                                                         nat.getValue = function() {
                                                                         return this.instance.@org.opencms.acacia.client.widgets.I_EditWidget::getValue()();
                                                                         }
                                                                         nat.setValue = function(value, fireEvent) {
                                                                         this.instance.@org.opencms.acacia.client.widgets.I_EditWidget::setValue(Ljava/lang/String;Z)(value, fireEvent);
                                                                         }
                                                                         nat.onAttachWidget = function() {
                                                                         this.instance.@org.opencms.acacia.client.widgets.I_EditWidget::onAttachWidget()();
                                                                         }
                                                                         ...
                                                                         widget.@org.opencms.acacia.client.widgets.I_EditWidget::addValueChangeHandler(Lcom/google/gwt/event/logical/shared/ValueChangeHandler;)(nativeHandler);
                                                                         widget.@org.opencms.acacia.client.widgets.I_EditWidget::addFocusHandler(Lcom/google/gwt/event/dom/client/FocusHandler;)(nativeHandler);
                                                                         return nat;
                                                                         }-*/;
