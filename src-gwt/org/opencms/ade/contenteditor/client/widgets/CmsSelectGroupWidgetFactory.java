 ...
 */
public class CmsSelectGroupWidgetFactory implements I_WidgetFactory, I_CmsHasInit {

    /** The widget name. */
    private static final String WIDGET_NAME = "org.opencms.widgets.CmsSelectGroupWidget";
    ...
    public static void initClass() {
        ...
        WidgetRegistry.getInstance().registerWidgetFactory(WIDGET_NAME, new CmsSelectGroupWidgetFactory());
    }
