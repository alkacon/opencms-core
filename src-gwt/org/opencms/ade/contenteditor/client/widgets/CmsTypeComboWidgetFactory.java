 ...
 */
public class CmsTypeComboWidgetFactory implements I_WidgetFactory, I_CmsHasInit {

    /** The widget name. */
    private static final String WIDGET_NAME = "org.opencms.widgets.CmsTypeComboWidget";
    ...
    public static void initClass() {
        ...
        WidgetRegistry.getInstance().registerWidgetFactory(WIDGET_NAME, new CmsTypeComboWidgetFactory());
    }
    ...
    public I_FormEditWidget createFormWidget(String configuration) {
        ...
        return new FormWidgetWrapper(new CmsComboWidget(configuration));
    }
    ...
    public I_EditWidget createInlineWidget(String configuration, Element element) {
        ...
        return new CmsComboWidget(configuration);
    }
