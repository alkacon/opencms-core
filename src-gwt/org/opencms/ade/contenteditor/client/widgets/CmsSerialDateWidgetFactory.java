 ...
 */
public class CmsSerialDateWidgetFactory implements I_WidgetFactory, I_CmsHasInit {

    /** The widget name. */
    private static final String WIDGET_NAME = "com.alkacon.opencms.v8.calendar.CmsSerialDateWidget";
    ...
    public I_FormEditWidget createFormWidget(String configuration) {
        ...
        return new FormWidgetWrapper(new CmsSerialDateWidget(configuration));
    }
