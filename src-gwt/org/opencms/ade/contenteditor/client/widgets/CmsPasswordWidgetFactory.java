 ...
 */
public class CmsPasswordWidgetFactory implements I_WidgetFactory, I_CmsHasInit {
    ...
    public I_FormEditWidget createFormWidget(String configuration) {
        ...
        return new FormWidgetWrapper(new CmsPasswordWidget());
    }
