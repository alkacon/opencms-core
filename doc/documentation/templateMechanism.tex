...
time consuming task (especially because the medicore runtime performance of the XML template mechanism). 
Therefore OpenCms provides an element caching mechanism 
