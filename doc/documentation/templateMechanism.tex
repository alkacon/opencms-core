...
Enter the name and title for the new template in the Create a new File of other type dialog box. 
Select {\name Text} as the type for your new template file, and click on {\name Finish} to end the 
creation 
of the new text file (Figure~\ref{createOT3}). 
...
\begin{minipage}[b]{0.499\linewidth}
   \begin{center}
   \includegraphics[clip,width=\sgw]
                   {pics/templateMech/createOT3}
   \end{center}
\end{minipage}
\caption[Creation of a new template]
           {Enter name and title and choose \textit{Text}}
 \label{createOT3}
