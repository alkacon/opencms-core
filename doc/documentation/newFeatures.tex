\section{New Features For Resources}
...
\subsection{Undelete resources} \index{undelete} When a resource
...
\subsection{Undo changes} \index{undo}
...
\subsection{Restore a version from history} \index{history}
...
\subsection{Publish a resource} \index{publish resource}
...
\subsection{Copy a resource to the project}
