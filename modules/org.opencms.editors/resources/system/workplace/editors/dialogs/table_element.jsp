<%@ page import="org.opencms.workplace.*" %><%	
	...
	String dialogTitle = org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_TITLE_CHANGETD_0);
	if ("TR".equals(titleType)) {
		dialogTitle = org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_TITLE_CHANGETR_0);
	} 
	...
	for ( elem in window.dialogArguments ) {
		...
		case "error_notable":
			if (window.dialogArguments["error_notable"] == "true") {
				...
				alert("<%=  org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_EDITOR_MESSAGE_NOTABLE_0) %>");
				window.close();
			}
			break;
		case "error_selection":
			if (window.dialogArguments["error_selection"] == "true") {
				...
				alert("<%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_EDITOR_MESSAGE_SELECTION_0) %>");
				window.close();
			}
			break;
		}
...
<tr>
  ...
  <td style="white-space: nowrap;"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_BORDERINFO_0)%></td>
</tr>
<tr>
...
<tr>
  <td style="white-space: nowrap;"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_ALIGN_0)%>: </td>
  <td colspan="2"><select name="TDAlign" id="TDAlign" size="1" style="width:150px;">
        <option value=""><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_EDITOR_DIALOG_TABLE_NOTSPECIFIED_0)%></option>
...
<tr>
  <td style="white-space: nowrap;"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_VALIGN_0)%>: </td>
  <td colspan="2"><select name="TDVAlign" id="TDVAlign" size="1" style="width:150px;">
        <option value=""><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_EDITOR_DIALOG_TABLE_NOTSPECIFIED_0) %></option>
        <option value="top"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_VALIGNTOP_0) %></option>
        <option value="middle"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_VALIGNMIDDLE_0) %></option>
        <option value="bottom"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_VALIGNBOTTOM_0) %></option>        
        <option value="baseline"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_VALIGNBASELINE_0) %></option>
      </select>
</tr>
<tr>
  <td style="white-space: nowrap;"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_TBGCOLOR_0) %>:</td>
...
<tr>
  <td style="white-space: nowrap;"><%= org.opencms.workplace.editors.Messages.get().key(wp.getLocale(), org.opencms.workplace.editors.Messages.GUI_INPUT_TBORDERCOLOR_0)%>:</td>
