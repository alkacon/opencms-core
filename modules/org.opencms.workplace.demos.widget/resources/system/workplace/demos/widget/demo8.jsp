<%@ page 
	...
	CmsAdminWidgetDemo8 wp = new CmsAdminWidgetDemo8(pageContext, request, response);
		
//////////////////// start of switch statement 
switch (wp.getAction()) {
    case CmsAdminWidgetDemo8.ACTION_CANCEL:
...
<%
    ...
    case CmsAdminWidgetDemo8.ACTION_DEFAULT:
    default:
