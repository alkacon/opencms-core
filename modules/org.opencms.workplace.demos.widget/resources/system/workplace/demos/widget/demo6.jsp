<%@ page 
	...
	CmsAdminWidgetDemo6 wp = new CmsAdminWidgetDemo6(pageContext, request, response);
		
//////////////////// start of switch statement 
switch (wp.getAction()) {
    case CmsAdminWidgetDemo6.ACTION_CANCEL:
//////////////////// ACTION: cancel button pressed
	wp.actionCloseDialog();
	break;

    case CmsAdminWidgetDemo6.ACTION_ERROR:
//////////////////// ACTION: an error occurred
	break;
	
    case CmsAdminWidgetDemo6.ACTION_SAVE:
...
<%
    ...
    case CmsAdminWidgetDemo6.ACTION_DEFAULT:
    default:
