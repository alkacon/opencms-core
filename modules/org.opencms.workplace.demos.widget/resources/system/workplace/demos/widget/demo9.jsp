<%@ page 
	...
	CmsAdminWidgetDemo9 wp = new CmsAdminWidgetDemo9(pageContext, request, response);
		
//////////////////// start of switch statement 
switch (wp.getAction()) {
    case CmsAdminWidgetDemo9.ACTION_CANCEL:
//////////////////// ACTION: cancel button pressed
	wp.actionCloseDialog();
	break;

    case CmsAdminWidgetDemo9.ACTION_ERROR:
//////////////////// ACTION: an error occurred
	break;
	
    case CmsAdminWidgetDemo9.ACTION_SAVE:
...
<%
    ...
    case CmsAdminWidgetDemo9.ACTION_DEFAULT:
    default:
