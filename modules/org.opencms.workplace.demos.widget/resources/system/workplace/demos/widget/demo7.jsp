...
<%	
	...
	CmsAdminWidgetDemo7 wp = new CmsAdminWidgetDemo7(pageContext, request, response);
		
//////////////////// start of switch statement 
switch (wp.getAction()) {
    case CmsAdminWidgetDemo7.ACTION_CANCEL:
//////////////////// ACTION: cancel button pressed
	wp.actionCloseDialog();
	break;

    case CmsAdminWidgetDemo7.ACTION_SAVE:
...
<%
    ...
    case CmsAdminWidgetDemo7.ACTION_DEFAULT:
    default:
