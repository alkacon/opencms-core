...
<%	
	...
	CmsAdminWidgetDemo3 wp = new CmsAdminWidgetDemo3(pageContext, request, response);
		
//////////////////// start of switch statement 
switch (wp.getAction()) {
    case CmsAdminWidgetDemo3.ACTION_CANCEL:
//////////////////// ACTION: cancel button pressed
	wp.actionCloseDialog();
	break;

    case CmsAdminWidgetDemo3.ACTION_SAVE:
...
<%
    ...
    case CmsAdminWidgetDemo3.ACTION_DEFAULT:
    default:
