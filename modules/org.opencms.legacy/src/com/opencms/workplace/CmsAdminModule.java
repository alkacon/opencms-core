/*
* File   : $Source: /alkacon/cvs/opencms/modules/org.opencms.legacy/src/com/opencms/workplace/Attic/CmsAdminModule.java,v $
...
public class CmsAdminModule extends CmsWorkplaceDefault {
    ...
    public Vector moduleList(CmsObject cms, CmsXmlLanguageFile lang)
        throws CmsException {
        Vector retVec = new Vector(OpenCms.getModuleManager().getModuleNames());
