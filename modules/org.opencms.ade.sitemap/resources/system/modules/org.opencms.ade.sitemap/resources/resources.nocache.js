function resources(){
  ...
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['gecko'], '061FC65BB6000D49C029B994225D26FF');
      unflattenKeylistIntoAnswers(['opera'], '12C27E43CDBDE9034F7CAEC7DB55E640');
      unflattenKeylistIntoAnswers(['gecko1_8'], '3B13A7C67CE09E792442580946CDE732');
      unflattenKeylistIntoAnswers(['safari'], 'B07CFB3A45FFA0956209370E01470584');
      unflattenKeylistIntoAnswers(['ie8'], 'CED5AFC31E39E186669890E11FD4D55E');
      unflattenKeylistIntoAnswers(['ie6'], 'D6B8F328F70E301D7F2E591A164834F8');
