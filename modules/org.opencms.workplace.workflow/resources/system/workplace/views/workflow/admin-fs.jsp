...
//--></script>
	...
	<frameset cols="<%=(wp.withMenu()?"212,":"")%>*" border="0" frameborder="0" framespacing="0">
<%    if (wp.withMenu()) { %>                
		<frame <%= wp.getFrameSource("admin_menu", jsp.link("../admin/admin-menu.jsp") + params) %> frameborder="0" border="0" noresize scrolling="auto">
<%    } %>
