...
"%><%	
    ...
    if (! wp.useNewStyle()) {
    	borderStyle = "2px inset #ffffff";
    	borderSimpleStyle = "2px solid #dddddd";
    } else {
...
// -->
    ...
    <%= wp.bodyStart("empty", "style=\"background-color:#dddddd;\" onLoad=\"init();\"") %><%= wp.bodyEnd() %>
    <%= wp.htmlEnd() %>
