...
<title><%= wp.key(org.opencms.workplace.Messages.GUI_LABEL_WPTITLE_2, new Object[]{wp.getSettings().getUser().getDisplayName(wp.getCms(), wp.getLocale()), request.getServerName()}) %></title>
