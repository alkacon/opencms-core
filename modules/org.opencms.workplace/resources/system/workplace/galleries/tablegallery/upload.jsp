...
if (CmsStringUtil.isNotEmpty(request.getParameter("gallery"))) {
	...
	//redirect URL  
	params.put(CmsNewResourceUpload.PARAM_REDIRECTURL, A_CmsAjaxGallery.PATH_GALLERIES + "tablegallery/upload.jsp");  
	params.put(CmsNewResourceUpload.PARAM_REDIRECT, "true");
	params.put(CmsDialog.PARAM_CLOSELINK, wp.getJsp().link(A_CmsAjaxGallery.PATH_GALLERIES + "tablegallery/upload.jsp"));
	wp.sendForward(CmsNewResourceUpload.VFS_PATH_COMMONS + "newcsvfile_upload.jsp", params);
} else {
