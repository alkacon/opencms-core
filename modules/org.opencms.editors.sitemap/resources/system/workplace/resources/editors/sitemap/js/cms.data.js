﻿(function(cms) {
   ...
   var /** String */ BACKLINK_URL = cms.data.BACKLINK_URL = '/system/workplace/resources/editors/sitemap/backlink.html';
   ...
   /**
    * Initial load function that loads all data needed for sitemap to start.
    *
    ...
    */
   var postJSON = cms.data.postJSON = /** void */ function(/** String */action, /** Object */ data, /** void Function(boolean, Object) */ afterPost, /** boolean */ sync) {
   ...
   */
   var getPublishList = cms.data.getPublishList = function(related, siblings, project, callback) {
       ...
       postJSON('publish_list', params, callback)
   }
   ...
   */
   var publishResources = cms.data.publishResources = function(resources, removeResources, force, callback) {
       ...
       postJSON('publish', params, callback);
   }
