...
--%><div class="sidelist"><p class="sidelisthead"><fmt:message key="news.headline" /></p><cms:contentload collector="${param.collector}" param="${param.folder}news_${number}.html|30|${param.count}" editable="true">
