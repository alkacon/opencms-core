...
public class VieTest extends GWTTestCase {
    ...
    public void testCopyAndRemoveEntity() {
        ...
        Type veryComplex = vie.createType(typeId);
        ...
        Entity attributeEntity = vie.createEntity(attributeEntityId, COMPLEX_TYPE_ID);
        String value = "my attribute value";
        attributeEntity.addAttributeValue(ATTRIBUTE_NAME, value);
        String testEntityId = "my-test-entity";
        Entity testEntity = vie.createEntity(testEntityId, typeId);
        testEntity.addAttributeValue(complexAttributeName, attributeEntity);

        Entity copy = testEntity.createDeepCopy("my-entity-copy");
        EntityAttribute attribute = copy.getAttribute(complexAttributeName);
    ...
    public void testCreateEntity() {
        ...
        Entity entity = vie.createEntity(entityId, entityType);
    ...
    public void testCreateType() {
        ...
        Type type = getVieInstance().createType(typeId);
    ...
    public void testEntityAttribute() {
        ...
        Type simple = vie.createType(SIMPLE_TYPE_ID);
        Type complex = vie.createType(COMPLEX_TYPE_ID);
        ...
        Entity entity = vie.createEntity("my-entity", complex.getId());
        String value = "my attribute value";
        entity.addAttributeValue(ATTRIBUTE_NAME, value);
        EntityAttribute attribute = entity.getAttribute(ATTRIBUTE_NAME);
        ...
        Entity entity2 = vie.createEntity("my-second-entity", complex.getId());
        String value2 = "";
        entity2.addAttributeValue(ATTRIBUTE_NAME, value2);
        EntityAttribute attribute2 = entity2.getAttribute(ATTRIBUTE_NAME);
    ...
    public void testSameValueAttributes() {
        ...
        Type simpleType = vie.createType(mySimple);
        Type complexNested = vie.createType(myComplexNested);
        complexNested.addAttribute(ATTRIBUTE_NAME, simpleType, 1, 3);
        Type complex = vie.createType(myComplex);
        complex.addAttribute(nestedAttributeName, complex, 1, 3);
        // testing attribute values
        Entity nestedEntity = vie.createEntity("my-same-value-entity", complexNested.getId());
        String value = "test";
        nestedEntity.addAttributeValue(ATTRIBUTE_NAME, value);
        nestedEntity.addAttributeValue(ATTRIBUTE_NAME, value);
        nestedEntity.addAttributeValue(ATTRIBUTE_NAME, value);
        Entity mainEntity = vie.createEntity("kljsfh", complex.getId());
