 ...
 * @version $Revision: 1.10 $ $Date: 2001/01/24 09:41:40 $  
 * 
 * */
public class CmsMultipartRequest implements HttpServletRequest {
     ...
     */
    public CmsMultipartRequest(HttpServletRequest request) throws IOException {
     ...
     */
    public CmsMultipartRequest(HttpServletRequest request, int maxPostSize) throws IOException {
     ...
     */
    protected String readAndSaveFile(CmsMultipartInputStreamHandler in, String boundary) throws IOException {
     ...
     * @see readAndSaveFile
     */
    protected boolean readNextPart(CmsMultipartInputStreamHandler in, String boundary) throws IOException {
     ...
     * request
     */
    protected String readParameter(CmsMultipartInputStreamHandler in, String boundary) throws IOException {
