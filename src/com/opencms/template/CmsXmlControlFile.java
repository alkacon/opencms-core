 ...
 * @version $Revision: 1.42 $ $Date: 2003/09/17 08:31:29 $
 */
    ...
    public String getMasterTemplate() throws CmsException {
        ...
        if(result == null || "".equals(result)) {
            if(OpenCms.getLog(CmsLog.CHANNEL_MAIN).isErrorEnabled() ) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).error("[CmsXmlControlFile] <MASTERTEMPLATE> tag not found in file " + getAbsoluteFilename() + ".");
            }
            removeFromFileCache();
