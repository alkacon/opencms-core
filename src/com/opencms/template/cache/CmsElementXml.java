                ...
                try {
                    ...
                    if(theTemplate == null){
                        try{
                            ...
                            if(OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).isErrorEnabled()) {
                                OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).error("Could not find the body element to get the default template file for " + this.toString(), exc);
                            }
                        }
                    }
                    ...
                    if(e instanceof CmsException) {
                        ...
                        if(ce instanceof CmsSecurityException) {
                            ...
                            if(OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).isDebugEnabled()) {
                                OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).debug("Access denied in getContent for template class " + m_className);
                            }
                        } else {
                            // Any other CmsException.
                            // This could be more critical.
                            if(OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).isWarnEnabled()) {
                                OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).warn("Error in getContent() for template class " + m_className, e);
                            }
                        }
                        throw ce;
                    } else {
                        ...
                        if(OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).isErrorEnabled()) {
                            OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).error("Non OpenCms error occured in getContent for template class " + m_className, e);
                        }
