                ...
                try {
                    ...
                    if(theTemplate == null){
                        try{
                            ...
                            if(OpenCms.isLogging(CmsLog.C_OPENCMS_CRITICAL, CmsLog.LEVEL_ERROR)) {
                                OpenCms.log(CmsLog.C_OPENCMS_CRITICAL, CmsLog.LEVEL_ERROR, toString() + " could not find the body element to get the default templatefile for " + this.toString() );
                            }
                        }
                    }
                    ...
                    if(e instanceof CmsException) {
                        ...
                        if(ce instanceof CmsSecurityException) {
                            ...
                            if(OpenCms.isLogging(CmsLog.C_OPENCMS_DEBUG, CmsLog.LEVEL_WARN)) {
                                OpenCms.log(CmsLog.C_OPENCMS_DEBUG, CmsLog.LEVEL_WARN, toString() + " Access denied in getContent for template class " + m_className);
                            }
                        } else {
                            // Any other CmsException.
                            // This could be more critical.
                            if(OpenCms.isLogging(CmsLog.C_OPENCMS_INFO, CmsLog.LEVEL_WARN)) {
                                OpenCms.log(CmsLog.C_OPENCMS_INFO, CmsLog.LEVEL_WARN, toString() + " Error in getContent for template class " + m_className);
                            }
                        }
                        throw ce;
                    } else {
                        ...
                        if(OpenCms.isLogging(CmsLog.C_OPENCMS_CRITICAL, CmsLog.LEVEL_ERROR)) {
                            OpenCms.log(CmsLog.C_OPENCMS_CRITICAL, CmsLog.LEVEL_ERROR, toString() + " Non OpenCms error occured in getContent for template class " + m_className);
                        }
