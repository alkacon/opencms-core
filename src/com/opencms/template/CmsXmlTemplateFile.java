...
public class CmsXmlTemplateFile extends A_CmsXmlContent {
    ...
    public Element getBodyTag() throws CmsException {
        ...
        if(hasData("bodyTag")) {
            ...
            if(OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).isDebugEnabled() ) {
                OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).debug("Cannot find \"bodytag\" tag in XML template file " + getFilename());
            }
        }
        return result;
    }
    ...
    public String getProcessedTemplateContent(Object callingObject, Hashtable parameters, String templateSelector) throws CmsException {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).isDebugEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).debug("TemplateSelector is " + templateSelector);
        }
    ...
    public void renameSection(String oldName, String newName) throws CmsException {
        if(!hasData("template." + newName)) {
            if(OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).isInfoEnabled() ) {
                OpenCms.getLog(CmsLog.CHANNEL_TEMPLATE_XML).info("Datablock TEMPLATE." + newName + " not found, creating it");
            }
