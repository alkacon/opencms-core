...
protected Object getContentDefinition(CmsObject cms, Class contentClass, CmsUUID contentId) {
    ...
    try {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice contentDefinitionConstructor: Invocation target exception!");
        }
    } catch (NoSuchMethodException nsm) {
        if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice contentDefinitionConstructor: Requested method was not found!");
        }
    } catch (InstantiationException ie) {
        if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice contentDefinitionConstructor: the reflected class is abstract!");
        }
    } catch (Exception e) {
        if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice contentDefinitionConstructor: Other exception! " + e);
        }
        if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
    ...
    public Integer getHistory(CmsObject cms, CmsXmlLanguageFile lang, Vector names,
        ...
        if (id != null && !"".equals(id)) {
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice: history method throwed an exception!");
                }
            }
...
//            }
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice: changing permissions method throwed an exception!");
                }
  ...
  */
  ...
  private byte[] getContentList(CmsObject cms, CmsXmlWpTemplateFile template, String elementName, Hashtable parameters, String templateSelector) throws CmsException {
    ...
    if (currentFilter.getFilterName().equals(filterMethodName)) {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice: apply filter throwed an InvocationTargetException!");
      }
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice: apply filter method was not found!");
      }
      templateSelector = "error";
      template.setData("filtername", filterMethodName);
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice: apply filter: Other Exception! "+e);
      }
      templateSelector = "error";
      template.setData("filtername", filterMethodName);
    ...
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice getContentList: getFieldMethods throwed an exception");
      }
      templateSelector = "error";
      template.setData("filtername", filterMethodName);
    ...
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Could not get field method for "+(String)columnsVector.elementAt(j)+" - check for correct spelling!");
      }
    }
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice content definition object throwed an InvocationTargetException!");
      }
    } catch (Exception e) {
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice content definition object: Other exception! "+e);
      }
    }
    ...
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice: getUniqueId throwed an Exception!");
          }
    }
...
private Object getContentMethodObject(CmsObject cms, Class cdClass, String method, Class paramClasses[], Object params[]) {
    ...
    if (method != "") {
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + method + " throwed an InvocationTargetException!");
            }
            ite.getTargetException().printStackTrace();
        } catch (NoSuchMethodException nsm) {
            if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + method + ": Requested method was not found!");
            }
        } catch (Exception e) {
            if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + method + ": Other Exception!");
            }
        }
    }
    return retObject;
  ...
  private void setExtendedLockstates(CmsObject cms, CmsXmlWpTemplateFile template, Class cdClass,
        ...
        try {
            ...
            if (lockedByUserId.equals(actUserId)) {
                ...
                try {
                    ...
                    if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setLockstates: Method getLockedInProject throwed an exception: "+e.toString());
                    }
                }
    ...
    private void setProjectFlag(CmsObject cms, CmsXmlWpTemplateFile template, Class cdClass,
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setProjectFlag:'no project' section throwed an exception!");
            }
        }
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setProjectFlag: Method getState throwed an exception: "+e.toString());
            }
        }
        ...
        if (state == 0) {
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setProjectFlag: Method getLockedInProject throwed an exception: "+e.toString());
                }
            }
            try {
                //show the possible cases of a lockstate in the template
    ...
    private String getStyle(CmsObject cms, CmsXmlWpTemplateFile template, Object entryObject) {
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setFontFormat: Method getProjectId throwed an exception: "+e.toString());
            }
        }
        ...
        if (actProjectId == I_CmsConstants.C_PROJECT_ONLINE_ID) {
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setFontFormat: Method getLockstate throwed an exception: "+e.toString());
                }
            }
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setFontFormat: Method getState throwed an exception: "+e.toString());
                }
            }
    ...
    private void setContextMenu(CmsObject cms, CmsXmlWpTemplateFile template, Object entryObject) {
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setContextMenu: Method getProjectId throwed an exception: "+e.toString());
            }
        }
        ...
        if (actProjectId == I_CmsConstants.C_PROJECT_ONLINE_ID) {
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setContextMenu: Method getLockstate throwed an exception: "+e.toString());
                }
            }
            // get the state of an entry: if its unchanged do not change the font
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setContextMenu: Method getState throwed an exception: "+e.toString());
                }
            }
            if (lockedByUserId.isNullUUID()) {
                ...
                try {
                    ...
                    if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
                        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice setContextMenu: Method getLockedInProject throwed an exception: "+e.toString());
                    }
                }
  ...
  */
  private Vector getFilterMethods(CmsObject cms) {
    ...
    try {
      ...
      //error occured while applying the filter
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice getContentHead: InvocationTargetException!");
      }
    } catch (NoSuchMethodException nsm) {
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice getContentHead: Requested method was not found!");
      }
    } catch (Exception e) {
      if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isInfoEnabled()) {
    OpenCms.getLog(CmsLog.CHANNEL_MAIN).info(getClassName() + ": Backoffice getContentHead: Problem occured with your filter methods: "+e.toString());
      }
    }
    ...
    if (((action.equals("save")) || (action.equals("saveexit"))) && (error.equals(""))) {
      try {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isErrorEnabled()) {
          OpenCms.getLog(CmsLog.CHANNEL_MAIN).error(getClassName() + "Error while saving data to Content Definition "+ex.toString());
        }
      ...
      if ((action.equals("exit")) || ((action.equals("saveexit")) && (error.equals("")))) {
        try {
          ...
          return "done";
           ...
           if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isErrorEnabled()) {
             OpenCms.getLog(CmsLog.CHANNEL_MAIN).error(getClassName() + "Error while doing redirect "+e.toString());
          }
  ...
  private void setDatablocks(CmsObject cms, CmsXmlWpTemplateFile template,
    ...
    for (int i=0; i<methods.size(); i++) {
      ...
      try {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isErrorEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MAIN).error(getClassName() + "Error during automatic call method '"+methodName+"':"+e.toString());
        }
      } // try
    } //for
  } //setDatablocks
    ...
    while (keys.hasMoreElements()) {
          ...
          if (m!=null) {
            ...
            try {
              ...
              if (OpenCms.getLog(CmsLog.CHANNEL_MAIN).isErrorEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MAIN).error(getClassName() + "Error during automatic call method '"+m.getName()+"':"+e.toString());
              }
            } // try
          } //if
    } // while
