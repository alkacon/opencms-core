...
protected Object getContentDefinition(CmsObject cms, Class contentClass, CmsUUID contentId) {
    ...
    try {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice contentDefinitionConstructor: Invocation target exception!");
        }
    } catch (NoSuchMethodException nsm) {
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice contentDefinitionConstructor: Requested method was not found!");
        }
    } catch (InstantiationException ie) {
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice contentDefinitionConstructor: the reflected class is abstract!");
        }
    } catch (Exception e) {
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice contentDefinitionConstructor: Other exception! " + e);
        }
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
...
//                    A_OpenCms.log(CmsLog.CHANNEL_MODULE_MASTER);
//                }
        ...
        if (action == null || action.equals("")) {
            ...
            if (versionId != null && !"".equals(versionId)) {
                ...
                try {
                    ...
                    if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice: history method throwed an exception! "+e.getMessage());
                    }
            ...
            if (versionId != null && !"".equals(versionId)) {
                ...
                try {
                    ...
                    if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice: restore method throwed an exception! "+e.getMessage());
                    }
                    templateSelector = "historyerror";
                    template.setData("historyerror", e.getMessage());
                    //remove marker
    ...
    public Integer getHistory(CmsObject cms, CmsXmlLanguageFile lang, Vector names,
        ...
        if (id != null && !"".equals(id)) {
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice: history method throwed an exception!");
                }
            }
...
//            }
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice: changing permissions method throwed an exception!");
                }
  ...
  */
  ...
  private byte[] getContentList(CmsObject cms, CmsXmlWpTemplateFile template, String elementName, Hashtable parameters, String templateSelector) throws CmsException {
    ...
    if (currentFilter.getFilterName().equals(filterMethodName)) {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice: apply filter throwed an InvocationTargetException!");
      }
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice: apply filter method was not found!");
      }
      templateSelector = "error";
      template.setData("filtername", filterMethodName);
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice: apply filter: Other Exception! "+e);
      }
      templateSelector = "error";
      template.setData("filtername", filterMethodName);
    ...
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentList: getFieldMethods throwed an exception");
      }
      templateSelector = "error";
      template.setData("filtername", filterMethodName);
    ...
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Could not get field method for "+(String)columnsVector.elementAt(j)+" - check for correct spelling!");
      }
    }
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice content definition object throwed an InvocationTargetException!");
      }
    } catch (Exception e) {
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice content definition object: Other exception! "+e);
      }
    }
    ...
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice: getUniqueId throwed an Exception!");
          }
    }
...
//    }
    try {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentLock: Method getLockstate throwed an exception!");
      }
    }
    ...
    if (lockedByUserId.equals(actUserId)) {
        if (isExtendedList()) {
            ...
            if (curProjectId == lockedInProject) {
                ...
                try {
                    ...
                    if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentLock: Method setLockstate throwed an exception!");
                    }
                }
            } else {
                //steal lock
      ...
      try {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
      OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentLock: Method write throwed an exception!");
    }
      }
      templateSelector = "done";
    } else {
      ...
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentLock: Could not set lockstate!");
      }
    }
    //write to DB
    try {
    ...
    if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
      OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentLock: Could not write to content definition!");
        }
      }
    }
  }
...
private Object getContentMethodObject(CmsObject cms, Class cdClass, String method, Class paramClasses[], Object params[]) {
    ...
    if (method != "") {
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info(method + " throwed an InvocationTargetException!");
            }
            ite.getTargetException().printStackTrace();
        } catch (NoSuchMethodException nsm) {
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info(method + ": Requested method was not found!");
            }
        } catch (Exception e) {
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info(method + ": Other Exception!");
            }
        }
    }
    return retObject;
...
private void setLockstates(CmsObject cms, CmsXmlWpTemplateFile template, Class cdClass, Object entryObject, Hashtable parameters) {
    ...
    try {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setLockstates: Method isLockable throwed an Invocation target exception!");
        }
    } catch (NoSuchMethodException nsm) {
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setLockstates: Requested method isLockable was not found!");
        }
    } catch (Exception e) {
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setLockstates: Method isLockable throwed an exception: " + e.toString());
        }
    }
    ...
    if (la.equals("false")) {
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setLockstates:'not lockable' section hrowed an exception!");
            }
        }
    } else {
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setLockstates: Method getLockstate throwed an exception: " + e.toString());
            }
        }
        try {
            //show the possible cases of a lockstate in the template
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setLockstates throwed an exception: " + e.toString());
            }
        }
    }
}
  ...
  private void setExtendedLockstates(CmsObject cms, CmsXmlWpTemplateFile template, Class cdClass,
        ...
        try {
            ...
            if (lockedByUserId.equals(actUserId)) {
                ...
                try {
                    ...
                    if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setLockstates: Method getLockedInProject throwed an exception: "+e.toString());
                    }
                }
    ...
    private void setProjectFlag(CmsObject cms, CmsXmlWpTemplateFile template, Class cdClass,
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setProjectFlag:'no project' section throwed an exception!");
            }
        }
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setProjectFlag: Method getState throwed an exception: "+e.toString());
            }
        }
        ...
        if (state == 0) {
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setProjectFlag: Method getLockedInProject throwed an exception: "+e.toString());
                }
            }
            try {
                //show the possible cases of a lockstate in the template
    ...
    private String getStyle(CmsObject cms, CmsXmlWpTemplateFile template, Object entryObject) {
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setFontFormat: Method getProjectId throwed an exception: "+e.toString());
            }
        }
        ...
        if (actProjectId == I_CmsConstants.C_PROJECT_ONLINE_ID) {
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setFontFormat: Method getLockstate throwed an exception: "+e.toString());
                }
            }
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setFontFormat: Method getState throwed an exception: "+e.toString());
                }
            }
    ...
    private void setContextMenu(CmsObject cms, CmsXmlWpTemplateFile template, Object entryObject) {
        ...
        try {
            ...
            if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setContextMenu: Method getProjectId throwed an exception: "+e.toString());
            }
        }
        ...
        if (actProjectId == I_CmsConstants.C_PROJECT_ONLINE_ID) {
            ...
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setContextMenu: Method getLockstate throwed an exception: "+e.toString());
                }
            }
            // get the state of an entry: if its unchanged do not change the font
            try {
                ...
                if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setContextMenu: Method getState throwed an exception: "+e.toString());
                }
            }
            if (lockedByUserId.isNullUUID()) {
                ...
                try {
                    ...
                    if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
                        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice setContextMenu: Method getLockedInProject throwed an exception: "+e.toString());
                    }
                }
  ...
  */
  private Vector getFilterMethods(CmsObject cms) {
    ...
    try {
      ...
      //error occured while applying the filter
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
        OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentHead: InvocationTargetException!");
      }
    } catch (NoSuchMethodException nsm) {
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentHead: Requested method was not found!");
      }
    } catch (Exception e) {
      if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isInfoEnabled()) {
    OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).info("Backoffice getContentHead: Problem occured with your filter methods: "+e.toString());
      }
    }
    ...
    if (((action.equals("save")) || (action.equals("saveexit"))) && (error.equals(""))) {
      try {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isErrorEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).error("Error while saving data to Content Definition", ex);
        }
      ...
      if ((action.equals("exit")) || ((action.equals("saveexit")) && (error.equals("")))) {
        try {
          ...
          return "done";
           ...
           if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isErrorEnabled()) {
             OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).error("Error while doing redirect ", e);
          }
  ...
  private void setDatablocks(CmsObject cms, CmsXmlWpTemplateFile template,
    ...
    for (int i=0; i<methods.size(); i++) {
      ...
      try {
        ...
        if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isErrorEnabled()) {
            OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).error("Error during automatic call method '" + methodName, e);
        }
      } // try
    } //for
  } //setDatablocks
    ...
    while (keys.hasMoreElements()) {
          ...
          if (m!=null) {
            ...
            try {
              ...
              if (OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).isErrorEnabled()) {
                OpenCms.getLog(CmsLog.CHANNEL_MODULE_MASTER).error("Error during automatic call method '" + m.getName(), e);
              }
            } // try
          } //if
    } // while
