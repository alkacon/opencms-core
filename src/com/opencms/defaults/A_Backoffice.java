 ...
 * version 1.0
 */
public abstract class A_Backoffice extends CmsWorkplaceDefault {
    ...
    private Object getContentDefinitionConstructor(CmsObject cms, Class cdClass, Integer id) {
        Object o = null;
        try {
            Constructor c = cdClass.getConstructor(new Class[] {
                CmsObject.class, Integer.class
            });
     ...
     * @returns content definition object
     */
    private Object getContentDefinitionConstructor(CmsObject cms, Class cdClass, String id) {
        Object o = null;
        try {
            Constructor c = cdClass.getConstructor(new Class[] {
                CmsObject.class, String.class
            });
            o = c.newInstance(new Object[] {
                cms, id
            });
  ...
  template.setData("deleteerror", e.getMessage());
    ...
    private byte[] getContentHead(CmsObject cms, CmsXmlWpTemplateFile template, String elementName, Hashtable parameters, String templateSelector) throws CmsException {
        ...
        session.putValue("selectBoxValue", selectBoxValue); // store in session for Selectbox!
    ...
    private byte[] getContentList(CmsObject cms, CmsXmlWpTemplateFile template, String elementName, Hashtable parameters, String templateSelector) throws CmsException {
        ...
        try {
            Vector filterMethods = (Vector)cdClass.getMethod("getFilterMethods", new Class[] {
                CmsObject.class
            ...
            tableContent = (Vector)cdClass.getMethod("applyFilter", new Class[] {
                CmsObject.class, FilterMethod.class, String.class
            }).invoke(null, new Object[] {
                cms, filterMethod, filterParam
            });
        }
        catch(InvocationTargetException ite) {
        ...
        try {
            fieldMethods = (Vector)cdClass.getMethod("getFieldMethods", new Class[] {
                CmsObject.class
            }).invoke(null, new Object[] {
                cms
            });
        ...
        for(int i = 0;i < rows;i++) {
            ...
            for(int j = 0;j < columns;j++) {
                ...
                try {
                    id = (String)cdClass.getMethod("getUniqueId", new Class[] {
                        CmsObject.class
                    }).invoke(entryObject, new Object[] {
                        cms
                    });
                }
                catch(InvocationTargetException ite) {
    ...
    private byte[] getContentLock(CmsObject cms, CmsXmlWpTemplateFile template, String elementName, Hashtable parameters, String templateSelector) throws CmsException {
        ...
        // confirmation button pressed, process data!
            ...
            if(ls.equals("lockuser")) {
                ...
                try {
                    Method setLockstateMethod = (Method)cdClass.getMethod("setLockstate", new Class[] {
                        String.class
                    });
                    setLockstateMethod.invoke(o, new Object[] {
                        "lock"
                    });
                }
                catch(Exception e) {
                ...
                //write to DB
                try {
                    Method writeMethod = (Method)cdClass.getMethod("write", new Class[] {
                        CmsObject.class
                    });
                    writeMethod.invoke(o, new Object[] {
                        cms
                    });
                }
                catch(Exception e) {
     ...
     */
    public Integer setCheckbox(CmsObject cms, Vector names, Vector values, Hashtable parameters) throws CmsException {
        int returnValue = 0;
        CmsSession session = (CmsSession)cms.getRequestContext().getSession(true);
    ...
    private Vector getFilterMethods(CmsObject cms) {
        ...
        Class cdClass = getContentDefinitionClass();
        try {
            filterMethods = (Vector)cdClass.getMethod("getFilterMethods", new Class[] {
                CmsObject.class
            }).invoke(null, new Object[] {
                cms
            });
