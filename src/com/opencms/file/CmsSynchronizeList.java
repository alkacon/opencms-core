 ...
 * @version $Revision: 1.11 $ $Date: 2003/07/09 08:56:32 $
 */
public class CmsSynchronizeList implements I_CmsConstants, Serializable {
	 ...
	 */
	public CmsSynchronizeList(String resName, String transResName,
							  long modifiedVfs, long modifiedFs){
		m_resName=resName;
    ...
    public String toString(){
        String output =m_resName+":"+m_transResName+":"+m_modifiedVfs
        			  +":"+m_modifiedFs;
