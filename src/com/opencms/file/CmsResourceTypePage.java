...
public class CmsResourceTypePage implements I_CmsResourceType {
    ...
    public CmsResource createResource(CmsObject cms, String resourcename, Map properties, byte[] contents, Object parameter) throws CmsException {
        ...
        cms.doLockResource(bodyFolder + pageName, false);        
     ...
     */
    public void copyResource(CmsObject cms, String resourcename, String destination, boolean keepFlags, boolean lockCopy, int copyMode) throws CmsException {
    ...
    public void renameResource(CmsObject cms, String resourcename, String newname) throws CmsException {
        ...
        this.copyResource(cms, resourcename, newname, true, true,I_CmsConstants.C_COPY_PRESERVE_LINK);
        ...
        if (defaultBodyPath.equals(currentBodyPath)) {
            ...
            this.copyResource(cms, currentBodyPath, newname, true, true,I_CmsConstants.C_COPY_PRESERVE_LINK);
    ...
    private String readBodyPath(CmsObject cms, CmsFile file) throws CmsException {
        ...
        try {
            ...
            body = hXml.validateBodyPath(cms, body, file);
            body = cms.getRequestContext().getDirectoryTranslator().translateResource(I_CmsConstants.VFS_FOLDER_DEFAULT_SITE + body);
            if (body.startsWith(I_CmsConstants.VFS_FOLDER_DEFAULT_SITE))
                body = body.substring(I_CmsConstants.VFS_FOLDER_DEFAULT_SITE.length());
