...
/**
 * This interface describes a resource broker for metadefinitions in the Cms.<BR/>
 ...
 */
public interface I_CmsRbMetadefinition {
	 ...
	 */
	public I_CmsMetaDefinition readMetaDefinition(I_CmsUser callingUser, String name, I_CmsResourceType type);
	 ...
	 */	
	public Vector readAllMetaDefinitions(I_CmsUser callingUser, I_CmsResourceType type);
	 ...
	 * The Vector is maybe empty.
	 */	
	public Vector readAllMetaDefinitions(I_CmsUser callingUser, I_CmsResourceType resourcetype, int type);
	 ...
	 */
	public void writeMetaDefinition(I_CmsUser callingUser, String name, I_CmsResourceType resourcetype, 
									int type)
	 ...
	 * @exception CmsException Throws CmsException if something goes wrong.
	 */
	public void deleteMetaDefinition(I_CmsUser callingUser, String name, I_CmsResourceType type)
		throws CmsException;
