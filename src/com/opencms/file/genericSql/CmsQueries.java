 ...
 * 
 * @version $Revision: 1.31 $ $Date: 2000/10/31 13:11:26 $
 */
public class CmsQueries
{
	...
	public String C_PROJECTS_READ_BYTASK = "SELECT "+C_PROJECTS_RECORD+" FROM " + C_DATABASE_PREFIX + "PROJECTS where TASK_ID = ? ORDER BY PROJECT_NAME";
	public Integer C_PROJECTS_READ_BYUSER_KEY = new Integer(404);
	public String C_PROJECTS_READ_BYUSER = "SELECT "+C_PROJECTS_RECORD+" FROM " + C_DATABASE_PREFIX + "PROJECTS where USER_ID = ? and PROJECT_FLAGS = " + I_CmsConstants.C_PROJECT_STATE_UNLOCKED + " ORDER BY PROJECT_NAME";
	public Integer C_PROJECTS_READ_BYGROUP_KEY = new Integer(405);
	public String C_PROJECTS_READ_BYGROUP = "SELECT "+C_PROJECTS_RECORD+" FROM " + C_DATABASE_PREFIX + "PROJECTS where (GROUP_ID = ? or MANAGERGROUP_ID = ? ) and PROJECT_FLAGS = " + I_CmsConstants.C_PROJECT_STATE_UNLOCKED + " ORDER BY PROJECT_NAME";
	public Integer C_PROJECTS_READ_BYFLAG_KEY = new Integer(406);
	public String C_PROJECTS_READ_BYFLAG = "SELECT "+C_PROJECTS_RECORD+" FROM " + C_DATABASE_PREFIX + "PROJECTS where PROJECT_FLAGS = ? ORDER BY PROJECT_NAME";
