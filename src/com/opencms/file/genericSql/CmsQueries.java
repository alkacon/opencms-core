...
public class CmsQueries
{
	...
	public String C_PROJECTS_GETSITEFROMPROJECT = "SELECT SITE_ID, NAME, DESCRIPTION,CATEGORY_ID,LANGUAGE_ID, COUNTRY_ID, ONLINEPROJECT_ID FROM " + C_DATABASE_PREFIX + "SITES WHERE ONLINEPROJECT_ID = ? ";
	public Integer C_PROJECTS_GETSITEFROMNAME_KEY = new Integer(412);
	public String C_PROJECTS_GETSITEFROMNAME = "SELECT SITE_ID, NAME, DESCRIPTION,CATEGORY_ID,LANGUAGE_ID, COUNTRY_ID, ONLINEPROJECT_ID FROM " + C_DATABASE_PREFIX + "SITES WHERE NAME = ?";
