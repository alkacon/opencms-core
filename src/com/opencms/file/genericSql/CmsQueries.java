 ...
 * 
 * @version $Revision: 1.30 $ $Date: 2000/10/24 14:20:34 $
 */
  ...
  public String C_PROJECTS_RECORD = C_PROJECTS_PROJECT_ID+","+C_PROJECTS_USER_ID+","+C_PROJECTS_GROUP_ID+","+C_PROJECTS_MANAGERGROUP_ID+","+C_PROJECTS_TASK_ID+","+C_PROJECTS_PROJECT_NAME+","+C_PROJECTS_PROJECT_DESCRIPTION+","+C_PROJECTS_PROJECT_FLAGS+","+C_PROJECTS_PROJECT_CREATEDATE+","+C_PROJECTS_PROJECT_PUBLISHDATE+","+C_PROJECTS_PROJECT_PUBLISHED_BY+","+C_PROJECTS_PROJECT_TYPE+","+C_PROJECTS_PARENT_ID;	
	...
	public String C_PROJECTS_WRITE = "UPDATE " + C_DATABASE_PREFIX + "PROJECTS " + "SET USER_ID = ?, " + "GROUP_ID = ?, " + "MANAGERGROUP_ID = ?, " + "PROJECT_FLAGS = ?, " + "PROJECT_PUBLISHDATE = ?, " + "PROJECT_PUBLISHED_BY = ? " + "where PROJECT_ID = ?";
 	...
 	public String C_PROJECTS_PARENT_PROJECT =	"SELECT " + "pp." + C_PROJECTS_PROJECT_ID+", pp."+C_PROJECTS_USER_ID+", pp."+C_PROJECTS_GROUP_ID+", pp."+C_PROJECTS_MANAGERGROUP_ID+", pp."+C_PROJECTS_TASK_ID+", pp."+C_PROJECTS_PROJECT_NAME+", pp."+C_PROJECTS_PROJECT_DESCRIPTION+", pp."+C_PROJECTS_PROJECT_FLAGS+", pp."+C_PROJECTS_PROJECT_CREATEDATE+", pp."+C_PROJECTS_PROJECT_PUBLISHDATE+", pp."+C_PROJECTS_PROJECT_PUBLISHED_BY+", pp."+C_PROJECTS_PROJECT_TYPE+", pp."+C_PROJECTS_PARENT_ID + " "+
 																						"FROM " + C_DATABASE_PREFIX + "PROJECTS pp, " + C_DATABASE_PREFIX + "PROJECTS cp " + 
	...
	public Integer C_PROJECTS_PARENT_PROJECT_KEY =	new Integer(410);
 	...
 	public String C_PROJECTS_ONLINE_PROJECT =	"SELECT " + "p." + C_PROJECTS_PROJECT_ID+", p."+C_PROJECTS_USER_ID+", p."+C_PROJECTS_GROUP_ID+", p."+C_PROJECTS_MANAGERGROUP_ID+", p."+C_PROJECTS_TASK_ID+", p."+C_PROJECTS_PROJECT_NAME+", p."+C_PROJECTS_PROJECT_DESCRIPTION+", p."+C_PROJECTS_PROJECT_FLAGS+", p."+C_PROJECTS_PROJECT_CREATEDATE+", p."+C_PROJECTS_PROJECT_PUBLISHDATE+", p."+C_PROJECTS_PROJECT_PUBLISHED_BY+", p."+C_PROJECTS_PROJECT_TYPE+", p."+C_PROJECTS_PARENT_ID + " "+
 																						"FROM " + C_DATABASE_PREFIX + "PROJECTS p, " + C_DATABASE_PREFIX + "SITES SITES " + 
																						"WHERE p." + C_PROJECTS_PROJECT_ID + " = ? AND SITES.ONLINEPROJECT_ID = " + "p." + C_PROJECTS_PROJECT_ID;
 	public Integer C_PROJECTS_ONLINE_PROJECT_KEY =	new Integer(411);
 	

	//CMS_SITE_PROJECTS
	public Integer C_PROJECTS_GETONLINEPROJECT_KEY = new Integer(420);
	...
	public Integer C_PROJECTS_GETSITEFROMPROJECT_KEY = new Integer(421);
	public String C_PROJECTS_GETSITEFROMPROJECT = "SELECT SITE_ID, NAME, DESCRIPTION,CATEGORY_ID,LANGUAGE_ID, COUNTRY_ID, ONLINEPROJECT_ID, DELETED FROM " + C_DATABASE_PREFIX + "SITES WHERE ONLINEPROJECT_ID = ? ";
	public Integer C_PROJECTS_GETSITEFROMNAME_KEY = new Integer(422);
	public String C_PROJECTS_GETSITEFROMNAME = "SELECT SITE_ID, NAME, DESCRIPTION,CATEGORY_ID,LANGUAGE_ID, COUNTRY_ID, ONLINEPROJECT_ID, DELETED FROM " + C_DATABASE_PREFIX + "SITES WHERE NAME = ?";

	//Multisite Constants
	public Integer C_SITES_GETSITEFROMHOST_KEY = new Integer(450);
	public String C_SITES_GETSITEFROMHOST	= "SELECT " + C_DATABASE_PREFIX + "SITES.SITE_ID, NAME, DESCRIPTION,CATEGORY_ID,LANGUAGE_ID, COUNTRY_ID, ONLINEPROJECT_ID,DELETED FROM " + C_DATABASE_PREFIX + "SITES, " + C_DATABASE_PREFIX + "SITE_URLS WHERE URL = ? AND " + C_DATABASE_PREFIX + "SITE_URLS.SITE_ID = " + C_DATABASE_PREFIX + "SITES.SITE_ID"; 
	public Integer C_SITES_GETALLSITES_KEY = new Integer(451);
	public String C_SITES_GETALLSITES = "SELECT SITE_ID, NAME, DESCRIPTION,CATEGORY_ID,LANGUAGE_ID, COUNTRY_ID, ONLINEPROJECT_ID,DELETED FROM " + C_DATABASE_PREFIX + "SITES WHERE DELETED=0";
	...
	public Integer C_LANGUAGE_GETALLLANGUAGES_KEY = new Integer(460);
	public String C_LANGUAGE_GETALLLANGUAGES = "SELECT LANGUAGE_ID, NAME, SHORTNAME, PRIORITY FROM " + C_DATABASE_PREFIX + "LANGUAGE";
	public Integer C_COUNTRY_GETALLCOUNTRIES_KEY = new Integer(461);
	...
	public String C_SITE_DELETESITE = "UPDATE " + C_DATABASE_PREFIX + "SITES SET DELETED=1,NAME=? WHERE SITE_ID = ?";
	...
	public String C_SITES_GETSITEFROMSITEID = "SELECT SITE_ID, NAME, DESCRIPTION,CATEGORY_ID,LANGUAGE_ID, COUNTRY_ID, ONLINEPROJECT_ID,DELETED FROM " + C_DATABASE_PREFIX + "SITES WHERE SITE_ID = ? ";
	...
	public String C_SITESSITEURLS_CHECKSITE = "SELECT NAME FROM " + C_DATABASE_PREFIX + "SITE_URLS U, " + C_DATABASE_PREFIX + "SITES S WHERE S.SITE_ID <> ? AND S.SITE_ID=U.SITE_ID AND (LOWER(NAME) = ? OR LOWER(URL) = ?) AND DELETED = 0";
	...
	public String C_GET_SITEMATRIXINFO = "SELECT " + C_DATABASE_PREFIX + "SITES.SITE_ID SITE_ID, " + C_DATABASE_PREFIX + "SITES.NAME SITE_NAME, " + C_DATABASE_PREFIX + "SITES.CATEGORY_ID, " + C_DATABASE_PREFIX + "SITES.LANGUAGE_ID, " + C_DATABASE_PREFIX + "SITES.COUNTRY_ID, " + C_DATABASE_PREFIX + "LANGUAGE.SHORTNAME LANG_SNAME, " + C_DATABASE_PREFIX + "LANGUAGE.NAME LANG_NAME, " + C_DATABASE_PREFIX + "COUNTRY.SHORTNAME COUNTRY_SNAME, " + C_DATABASE_PREFIX + "COUNTRY.NAME COUNTRY_NAME," + C_DATABASE_PREFIX + "SITE_URLS.URL URL FROM " + C_DATABASE_PREFIX + "SITES," + C_DATABASE_PREFIX + "COUNTRY," + C_DATABASE_PREFIX + "LANGUAGE," + C_DATABASE_PREFIX + "SITE_URLS WHERE " + C_DATABASE_PREFIX + "SITES.DELETED=0 AND " + C_DATABASE_PREFIX + "SITES.LANGUAGE_ID=" + C_DATABASE_PREFIX + "LANGUAGE.LANGUAGE_ID AND " + C_DATABASE_PREFIX + "SITES.COUNTRY_ID=" + C_DATABASE_PREFIX + "COUNTRY.COUNTRY_ID AND " + C_DATABASE_PREFIX + "SITE_URLS.SITE_ID=" + C_DATABASE_PREFIX + "SITES.SITE_ID ORDER BY " + C_DATABASE_PREFIX + "COUNTRY.PRIORITY," + C_DATABASE_PREFIX + "LANGUAGE.PRIORITY";
