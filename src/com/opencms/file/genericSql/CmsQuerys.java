 ...
 * 
 * @version $Revision: 1.2 $ $Date: 2000/09/08 12:19:19 $
 */
public abstract class CmsQuerys
{
	...
	// generic SQL
	public static final String C_RESOURCES_GET_LOST_ID = "SELECT FILE_ID FROM " + C_DATABASE_PREFIX + "FILES WHERE FILE_ID NOT IN ( SELECT FILE_ID FROM " + C_DATABASE_PREFIX + "RESOURCES)";
	public static final Integer C_RESOURCES_DELETE_PROJECT_KEY = new Integer(105);
	public static final String C_RESOURCES_DELETE_PROJECT = "DELETE FROM " + C_DATABASE_PREFIX + "RESOURCES " + "WHERE PROJECT_ID = ?";
	...
	public static final String C_RESOURCES_UPDATE = "UPDATE " + C_DATABASE_PREFIX + "RESOURCES SET " + "RESOURCE_TYPE = ? , " + "RESOURCE_FLAGS = ? , " + "USER_ID = ? , " + "GROUP_ID = ? , " + "PROJECT_ID = ? ," + "ACCESS_FLAGS = ? ," + "STATE = ? , " + "LOCKED_BY = ? , " + "LAUNCHER_TYPE = ? , " + "LAUNCHER_CLASSNAME = ? ," + "DATE_LASTMODIFIED = ? ," + "RESOURCE_LASTMODIFIED_BY = ? ," + "RESOURCE_SIZE = ? , " + "FILE_ID = ? " + "WHERE RESOURCE_ID = ?";
	...
	public static final String C_RESOURCES_GET_SUBFOLDER = "SELECT * FROM " + C_DATABASE_PREFIX + "RESOURCES WHERE PARENT_ID = ? AND RESOURCE_TYPE = " + I_CmsConstants.C_TYPE_FOLDER + " ORDER BY RESOURCE_NAME";
	public static final Integer C_RESOURCES_PUBLISH_PROJECT_READFILE_KEY = new Integer(110);
	public static final String C_RESOURCES_PUBLISH_PROJECT_READFILE = "SELECT " + C_DATABASE_PREFIX + "RESOURCES.RESOURCE_NAME, " + "RESOURCE_ID,PARENT_ID,FILE_ID," + "RESOURCE_TYPE," + "RESOURCE_FLAGS,USER_ID," + "GROUP_ID,ACCESS_FLAGS,STATE," + "LOCKED_BY,LAUNCHER_TYPE,LAUNCHER_CLASSNAME," + "DATE_CREATED,DATE_LASTMODIFIED,RESOURCE_LASTMODIFIED_BY,RESOURCE_SIZE " + " FROM " + C_DATABASE_PREFIX + "RESOURCES " + "WHERE " + C_DATABASE_PREFIX + "RESOURCES.PROJECT_ID = ? " + "AND " + C_DATABASE_PREFIX + "RESOURCES.RESOURCE_TYPE <> " + I_CmsConstants.C_TYPE_FOLDER;
	public static final Integer C_RESOURCES_PUBLISH_PROJECT_READFOLDER_KEY = new Integer(111);
	public static final String C_RESOURCES_PUBLISH_PROJECT_READFOLDER = "SELECT " + C_DATABASE_PREFIX + "RESOURCES.RESOURCE_NAME, " + "RESOURCE_ID,PARENT_ID,FILE_ID," + "RESOURCE_TYPE," + "RESOURCE_FLAGS,USER_ID," + "GROUP_ID,ACCESS_FLAGS,STATE," + "LOCKED_BY,LAUNCHER_TYPE,LAUNCHER_CLASSNAME," + "DATE_CREATED,DATE_LASTMODIFIED,RESOURCE_LASTMODIFIED_BY,RESOURCE_SIZE " + " FROM " + C_DATABASE_PREFIX + "RESOURCES " + "WHERE " + C_DATABASE_PREFIX + "RESOURCES.PROJECT_ID = ? " + "AND " + C_DATABASE_PREFIX + "RESOURCES.RESOURCE_TYPE <> " + I_CmsConstants.C_TYPE_FOLDER;
	public static final Integer C_RESOURCES_UPDATE_FILE_KEY = new Integer(112);
	public static final String C_RESOURCES_UPDATE_FILE = "UPDATE " + C_DATABASE_PREFIX + "RESOURCES SET " + "RESOURCE_TYPE = ? , " + "RESOURCE_FLAGS = ? , " + "USER_ID = ? , " + "GROUP_ID = ? , " + "PROJECT_ID = ? ," + "ACCESS_FLAGS = ? ," + "STATE = ? , " + "LOCKED_BY = ? , " + "LAUNCHER_TYPE = ? , " + "LAUNCHER_CLASSNAME = ? ," + "DATE_LASTMODIFIED = ? ," + "RESOURCE_LASTMODIFIED_BY = ? ," + "RESOURCE_SIZE = ? , " + "FILE_ID = ? " + "WHERE RESOURCE_ID = ?";
	public static final Integer C_RESOURCES_UNLOCK_KEY = new Integer(120);
	public static final String C_RESOURCES_UNLOCK = "UPDATE " + C_DATABASE_PREFIX + "RESOURCES SET " + "LOCKED_BY = " + I_CmsConstants.C_UNKNOWN_ID + "WHERE PROJECT_ID = ?";
	public static final Integer C_RESOURCES_COUNTLOCKED_KEY = new Integer(121);
	public static final String C_RESOURCES_COUNTLOCKED = "SELECT COUNT(RESOURCE_ID) FROM " + C_DATABASE_PREFIX + "RESOURCES where LOCKED_BY <> " + I_CmsConstants.C_UNKNOWN_ID + " and PROJECT_ID = ?";
	...
	public static final String C_RESOURCES_PUBLISH_MARKED = "select OL.*, OFF.* from " + C_DATABASE_PREFIX + "RESOURCES  OL, " + C_DATABASE_PREFIX + "RESOURCES  OFF " + "where OFF.PROJECT_ID = ? and OL.PROJECT_ID = ? and OFF.RESOURCE_NAME = OL.RESOURCE_NAME and OFF.STATE = ? " + "order by OFF.RESOURCE_NAME";
	public static final Integer C_RESOURCES_DELETEBYID_KEY = new Integer(124);
	public static final String C_RESOURCES_DELETEBYID = "DELETE FROM " + C_DATABASE_PREFIX + "RESOURCES " + "WHERE RESOURCE_ID = ?";
	public static final Integer C_RESOURCES_READFOLDERSBYPROJECT_KEY = new Integer(125);
	public static final String C_RESOURCES_READFOLDERSBYPROJECT = "SELECT * FROM " + C_DATABASE_PREFIX + "RESOURCES where PROJECT_ID = ? AND RESOURCE_TYPE = " + I_CmsConstants.C_TYPE_FOLDER + " order by RESOURCE_NAME";
	public static final Integer C_RESOURCES_READFILESBYPROJECT_KEY = new Integer(126);
	public static final String C_RESOURCES_READFILESBYPROJECT = "SELECT * FROM " + C_DATABASE_PREFIX + "RESOURCES where PROJECT_ID = ? AND RESOURCE_TYPE <> " + I_CmsConstants.C_TYPE_FOLDER;
	public static final Integer C_RESOURCES_GET_FILESINFOLDER_KEY = new Integer(130);
	public static final String C_RESOURCES_GET_FILESINFOLDER = "SELECT * FROM " + C_DATABASE_PREFIX + "RESOURCES WHERE PARENT_ID = ? AND RESOURCE_TYPE <> " + I_CmsConstants.C_TYPE_FOLDER + " ORDER BY RESOURCE_NAME";
	public static final Integer C_RESOURCES_REMOVE_KEY = new Integer(131);
	public static final String C_RESOURCES_REMOVE = "UPDATE " + C_DATABASE_PREFIX + "RESOURCES SET " + "STATE = ?, LOCKED_BY = ?" + "WHERE RESOURCE_NAME = ? AND PROJECT_ID = ?";
	...
	public static final String C_RESOURCES_RENAMERESOURCE = "UPDATE " + C_DATABASE_PREFIX + "RESOURCES SET " + "RESOURCE_NAME = ? , " + "RESOURCE_LASTMODIFIED_BY = ? " + "WHERE RESOURCE_ID = ?";
	public static final Integer C_RESOURCES_UPDATE_LOCK_KEY = new Integer(141);
	public static final String C_RESOURCES_UPDATE_LOCK = "UPDATE " + C_DATABASE_PREFIX + "RESOURCES SET " + "LOCKED_BY = ? " + "WHERE RESOURCE_ID = ?";
	...
	public static final String C_FILES_UPDATE = "UPDATE " + C_DATABASE_PREFIX + "FILES SET " + "FILE_CONTENT = ? " + "WHERE FILE_ID = ? ";
	...
	public static final String C_GROUPS_READGROUP = "SELECT * FROM " + C_DATABASE_PREFIX + "GROUPS WHERE GROUP_NAME = ?";
	public static final Integer C_GROUPS_READGROUP2_KEY = new Integer(202);
	public static final String C_GROUPS_READGROUP2 = "SELECT * FROM " + C_DATABASE_PREFIX + "GROUPS WHERE GROUP_ID = ?";
	...
	public static final String C_GROUPS_GETGROUPSOFUSER = "SELECT * FROM " + C_DATABASE_PREFIX + "GROUPS G, " + C_DATABASE_PREFIX + "USERS U, " + C_DATABASE_PREFIX + "GROUPUSERS GU  " + "where U.USER_NAME = ? AND U.USER_ID=GU.USER_ID " + "AND GU.GROUP_ID = G.GROUP_ID";
	...
	public static final String C_PROPERTYDEF_READ = "Select * from " + C_DATABASE_PREFIX + "PROPERTYDEF where " + C_PROPERTYDEF_NAME + " = ? and " + C_PROPERTYDEF_RESOURCE_TYPE + " = ? ";
	public static final Integer C_PROPERTYDEF_READALL_A_KEY = new Integer(302);
	public static final String C_PROPERTYDEF_READALL_A = "Select * from " + C_DATABASE_PREFIX + "PROPERTYDEF where " + C_PROPERTYDEF_RESOURCE_TYPE + " = ? ";
	public static final Integer C_PROPERTYDEF_READALL_B_KEY = new Integer(303);
	public static final String C_PROPERTYDEF_READALL_B = "Select * from " + C_DATABASE_PREFIX + "PROPERTYDEF where " + C_PROPERTYDEF_RESOURCE_TYPE + " = ? and " + C_PROPERTYDEF_TYPE + " = ? ";
	...
	public static final String C_PROPERTYDEF_DELETE = "DELETE FROM " + C_DATABASE_PREFIX + "PROPERTYDEF WHERE " + C_PROPERTYDEF_ID + " = ? ";
	public static final Integer C_PROPERTYDEF_UPDATE_KEY = new Integer(306);
	public static final String C_PROPERTYDEF_UPDATE = "UPDATE " + C_DATABASE_PREFIX + "PROPERTYDEF SET " + C_PROPERTYDEF_TYPE + " = ? WHERE " + C_PROPERTYDEF_ID + " = ? ";
	...
	public static final String C_PROPERTIES_READALL_COUNT = "SELECT count(*) FROM " + C_DATABASE_PREFIX + "PROPERTIES WHERE " + C_PROPERTYDEF_ID + " = ?";
	...
	public static final String C_PROPERTIES_UPDATE = "UPDATE " + C_DATABASE_PREFIX + "PROPERTIES SET " + C_PROPERTY_VALUE + " = ? WHERE " + C_PROPERTY_RESOURCE_ID + " = ? and " + C_PROPERTYDEF_ID + " = ? ";
	...
	public static final String C_PROPERTIES_READALL = "SELECT " + C_DATABASE_PREFIX + "PROPERTIES.*, " + C_DATABASE_PREFIX + "PROPERTYDEF.PROPERTYDEF_NAME FROM " + C_DATABASE_PREFIX + "PROPERTIES, " + C_DATABASE_PREFIX + "PROPERTYDEF " + "WHERE " + C_DATABASE_PREFIX + "PROPERTIES.PROPERTYDEF_ID = " + C_DATABASE_PREFIX + "PROPERTYDEF.PROPERTYDEF_ID and " + C_DATABASE_PREFIX + "PROPERTIES.RESOURCE_ID = ? and " + C_DATABASE_PREFIX + "PROPERTYDEF.RESOURCE_TYPE = ?";
	public static final Integer C_PROPERTIES_DELETEALL_KEY = new Integer(356);
	public static final String C_PROPERTIES_DELETEALL = "DELETE FROM " + C_DATABASE_PREFIX + "PROPERTIES " + "WHERE RESOURCE_ID = ?";
	public static final Integer C_PROPERTIES_DELETE_KEY = new Integer(357);
	public static final String C_PROPERTIES_DELETE = "DELETE FROM " + C_DATABASE_PREFIX + "PROPERTIES " + "WHERE " + C_PROPERTYDEF_ID + " = ? and " + C_PROPERTY_RESOURCE_ID + " = ? ";
	...
	public static final String C_PROJECTS_WRITE = "UPDATE " + C_DATABASE_PREFIX + "PROJECTS " + "SET USER_ID = ?, " + "GROUP_ID = ?, " + "MANAGERGROUP_ID = ?, " + "PROJECT_FLAGS = ?, " + "PROJECT_PUBLISHDATE = ?, " + "PROJECT_PUBLISHED_BY = ? " + "where PROJECT_ID = ?";


	//
	public static final Integer C_PROJECTS_GETONLINEPROJECT_KEY = new Integer(410);
	public static final String C_PROJECTS_GETONLINEPROJECT = "SELECT BASEPROJECT_ID FROM " + C_DATABASE_PREFIX + "SITE_PROJECTS where PROJECT_ID = ?";

		public static final Integer C_PROJECTS_GETSITEFROMPROJECT_KEY = new Integer(411);
	public static final String C_PROJECTS_GETSITEFROMPROJECT = "SELECT SITE_ID, NAME, DESCRIPTION,CATEGORY_ID,LANGUAGE_ID, COUNTRY_ID FROM " + C_DATABASE_PREFIX + "SITES, " + C_DATABASE_PREFIX + "SITE_PROJECTS WHERE " + C_DATABASE_PREFIX + "SITE_PROJECTS.BASEPROJECT_ID = ? AND " + C_DATABASE_PREFIX + "SITE_PROJECTS.SITE_ID=" + C_DATABASE_PREFIX + "SITES.SITE_ID";
	...
	public static final String C_USERS_WRITE = "UPDATE " + C_DATABASE_PREFIX + "USERS " + "SET USER_DESCRIPTION = ?, " + "USER_FIRSTNAME = ?, " + "USER_LASTNAME = ?, " + "USER_EMAIL = ?, " + "USER_LASTLOGIN = ?, " + "USER_LASTUSED = ?, " + "USER_FLAGS = ?, " + "USER_INFO = ?, " + "USER_DEFAULT_GROUP_ID = ?, " + "USER_ADDRESS = ?, " + "USER_SECTION = ?, " + "USER_TYPE = ? " + "WHERE USER_ID = ? ";
	...
	public static final String C_TASK_FIELDS = "AUTOFINISH, ENDTIME, ESCALATIONTYPEREF, ID , INITIATORUSERREF, MILESTONEREF, NAME, " + "ORIGINALUSERREF , AGENTUSERREF, PARENT, PERCENTAGE, PERMISSION, PRIORITYREF , ROLEREF, " + "ROOT, STARTTIME, STATE , TASKTYPEREF , TIMEOUT, WAKEUPTIME, HTMLLINK";
	public static final Integer C_TASK_TYPE_COPY_KEY = new Integer(801);
	public static final String C_TASK_TYPE_COPY = "INSERT INTO " + C_TABLENAME_TASK + "  (id," + C_TASK_TYPE_FIELDS + ") " + "SELECT ?," + C_TASK_TYPE_FIELDS + " FROM  " + C_TABLENAME_TASKTYPE + "  WHERE id=?";
	public static final Integer C_TASK_UPDATE_KEY = new Integer(802);
	public static final String C_TASK_UPDATE = "UPDATE  " + C_TABLENAME_TASK + "  SET " + "name=?, " + "state=?, " + "tasktyperef=?, " + "root=?, " + "parent=?, " + "initiatoruserref=?, " + "roleref=?,  " + "agentuserref=?, " + "originaluserref=?, " + "starttime=?, " + "wakeuptime=?, " + "timeout=?, " + "endtime=?, " + "percentage=? , " + "permission=? , " + "priorityref=?, " + "escalationtyperef=?, " + "htmllink=?, " + "milestoneref=?, " + "autofinish=? " + " WHERE id=?";
	...
	public static final String C_TASK_END = "UPDATE  " + C_TABLENAME_TASK + "  Set " + "state=" + CmsDbAccess.C_TASK_STATE_ENDED + ", " + "percentage=?, " + "endtime=? " + "WHERE id=?";
	public static final Integer C_TASKLOG_WRITE_KEY = new Integer(805);
	public static final String C_TASKLOG_WRITE = "INSERT INTO " + C_TABLENAME_TASKLOG + " " + "(" + C_LOG_ID + "," + C_LOG_TASK + ", " + C_LOG_USER + "," + C_LOG_STARTTIME + "," + C_LOG_COMMENT + "," + C_LOG_TYPE + ") " + "VALUES (?,?,?,?,?,?)";
	...
	public static final String C_TASK_FIND_AGENT = "SELECT " + C_DATABASE_PREFIX + "USERS.USER_ID " + "FROM " + C_DATABASE_PREFIX + "GROUPUSERS, " + C_DATABASE_PREFIX + "USERS " + "WHERE GROUP_ID=? AND " + C_DATABASE_PREFIX + "GROUPUSERS.USER_ID=" + C_DATABASE_PREFIX + "USERS.USER_ID " + "ORDER BY USER_LASTUSED ASC";
	public static final Integer C_TASK_FORWARD_KEY = new Integer(808);
	public static final String C_TASK_FORWARD = "UPDATE " + C_TABLENAME_TASK + " SET " + C_TASK_ROLE + "=? ," + C_TASK_AGENTUSER + "=? " + "WHERE " + C_TASK_ID + "=?";
	public static final Integer C_TASKLOG_READ_LOGS_KEY = new Integer(809);
	public static final String C_TASKLOG_READ_LOGS = "SELECT * FROM " + C_TABLENAME_TASKLOG + " WHERE " + C_LOG_TASK + "=? " + " ORDER BY " + C_LOG_STARTTIME;
	public static final Integer C_TASKLOG_READ_PPROJECTLOGS_KEY = new Integer(810);
	public static final String C_TASKLOG_READ_PPROJECTLOGS = "SELECT " + C_LOG_ID + "," + C_LOG_COMMENT + "," + C_LOG_TASK + "," + C_LOG_USER + "," + C_LOG_STARTTIME + "," + C_LOG_TYPE + "," + C_LOG_EXUSERNAME + " " + "FROM " + C_TABLENAME_TASKLOG + ", " + C_TABLENAME_TASK + " " + "WHERE " + C_LOG_TASK + "=" + C_DATABASE_PREFIX + "Task.id AND " + C_DATABASE_PREFIX + "Task.root=? " + "ORDER BY " + C_LOG_STARTTIME;
