 ...
 * into one abstract class. The interface is local to package. <B>All</B> methods
 * get additional parameters (callingUser and currentproject) to check the security-
 * police.
 * 
 * @author Andreas Schouten
 * @version $Revision: 1.5 $ $Date: 1999/12/22 14:02:30 $
 */
interface I_CmsResourceBroker {
	 ...
	 */
	abstract A_CmsProject onlineProject(A_CmsUser currentUser, 
	 ...
	 */
	abstract boolean accessProject(A_CmsUser currentUser, A_CmsProject currentProject,
								   String projectname);
	 ...
	 * @exception CmsException Throws CmsException if something goes wrong.
	 */
	abstract public A_CmsProject publishProject(A_CmsUser currentUser, 
												A_CmsProject currentProject,
												String name)
		throws CmsException;
	 ...
	 * @exception CmsException Throws CmsException if operation was not succesful.
	 */	
	abstract boolean isAdmin(A_CmsUser currentUser, A_CmsProject currentProject)
         throws CmsException;
	 ...
	 * else it returns false.
	 */	
	abstract boolean isProjectLeader(A_CmsUser currentUser, A_CmsProject currentProject);
	 ...
	 */
	abstract A_CmsUser anonymousUser(A_CmsUser currentUser, A_CmsProject currentProject);
