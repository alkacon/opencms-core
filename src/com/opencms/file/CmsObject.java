 ...
 *  
 * @version $Revision: 1.114 $ $Date: 2000/09/21 08:47:44 $ 
 * 
 */
...
public CmsProject createProject(String name, String description, String groupname, String managergroupname) throws CmsException {
	return (m_rb.createProject(m_context.currentUser(), m_context.currentProject(), name, description, groupname, managergroupname));
}
/**
 ...
 * to rename the file, or if the file couldn't be renamed.  
 */
public void renameFolder(String oldname, String newname) throws CmsException {
	m_rb.renameFolder(m_context.currentUser(), m_context.currentProject(), oldname, newname);
}
/**
