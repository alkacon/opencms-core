...
public CmsUser addImportUser(String id, String name, String password, String recoveryPassword, String description,
    ...
    return (m_driverManager.addImportUser(m_context, id, name, password, recoveryPassword,
            description, firstname, lastname, email, flags, additionalInfos, defaultGroup,
...
protected CmsFile doCreateFile(String newFileName, byte[] contents, String type) throws CmsException {
    CmsFile file = m_driverManager.createFile(m_context, addSiteRoot(newFileName),
                                   contents, type, new HashMap());
    return file;
}
/**
 * Creates a new file with the given content and resourcetype.
...
protected CmsFolder doCreateFolder(String newFolderName, Map properties) throws CmsException {
	...
	protected CmsResource doImportResource(String newResourceName, int resourceType, Map properties, int launcherType,
    	...
    	CmsResource cmsResource = m_driverManager.importResource(m_context, addSiteRoot(newResourceName),
                                            resourceType, properties, launcherType, launcherClassname,
                                            ownername, groupname, accessFlags, lastmodified, filecontent);
    ...
    protected void doWriteResource(String resourcename, Map properties,
        ...
        throws CmsException{
        m_driverManager.writeResource(m_context, addSiteRoot(resourcename), properties,
                           username, groupname, accessFlags, resourceType, filecontent);
    }
/**
...
public void exportStaticResources(Vector startpoints, Vector projectResources, Vector allExportedLinks,
    ...
    m_driverManager.exportStaticResources(this, m_context,
             startpoints, projectResources, allExportedLinks, changedResources, report);
}
...
public Vector getUsersByLastname(String Lastname,
    ...
    return m_driverManager.getUsersByLastname(m_context,
                                   Lastname,
                                   UserType,
                                   UserStatus,
                                   wasLoggedIn,
...
public int publishResource(String resourcename, boolean justPrepare, I_CmsReport report) throws CmsException {
    ...
    if(oldProjectId != C_PROJECT_ONLINE_ID){
        ...
        if(isAdmin() || isManagerOfProject()){
            int newProjectId = m_driverManager.createDirectPublishProject(m_context, "Direct Publish",
                                              "","Users","Projectmanager",
                                              I_CmsConstants.C_PROJECT_TYPE_TEMPORARY).getId();                                              
