...
public class CmsStaticExport implements I_CmsConstants {
     ...
     * @throws CmsException if something goes wrong
     */
    public CmsStaticExport(CmsObject cms, Vector startpoints, boolean doTheExport, Vector changedLinks, Vector allExportedLinks, CmsPublishedResources changedResources, I_CmsReport report) throws CmsException {
        m_cms = cms;
    ...
    /**
     * Checks if a link on a https page needs the http prefix.<p>
     * 
     * Uses the property value https_enabled and dynamic_https_enabled on
     * the property export.
     * 
     * @param link the link to test
     * @return true if the prefix is needed
     */
                ...
                if (resWithProp != null && resWithProp.size() != 0) {
                    ...
                    for (int i = 0; i < resWithProp.size(); i++) {
                        ...
                        if (newName != null) {
                            ...
                            if (CmsObject.getStaticExportProperties().isExportDefault()) {
                                m_dynamicExportNameRules.addElement("s#^" + resName + "#" + CmsObject.getStaticExportProperties().getUrlPrefixArray()[0] + newName + "#");
                            } else {
                                m_dynamicExportNameRules.addElement("s#^(" + CmsObject.getStaticExportProperties().getUrlPrefixArray()[0] + ")" + resName + "#$1" + newName + "#");
                            }
