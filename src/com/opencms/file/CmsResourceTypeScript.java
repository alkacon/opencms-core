...
/**
 * This class describes the resource-type script.
 *
 * @author
 * @version 1.0
 */

public class CmsResourceTypeScript extends CmsResourceTypePlain {

    public static final String C_TYPE_RESOURCE_NAME = "script";
