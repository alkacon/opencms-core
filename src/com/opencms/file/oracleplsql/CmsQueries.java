...
public class CmsQueries extends com.opencms.file.genericSql.CmsQueries
{
    ...
    public CmsQueries() {
        if(m_queries == null) {
            ...
            try {
                m_queries.load(getClass().getClassLoader().getResourceAsStream("com/opencms/file/oracleplsql/query.properties"));
            } catch(NullPointerException exc) {
                if(A_OpenCms.isLogging() && I_CmsLogChannels.C_PREPROCESSOR_IS_LOGGING) {
                    A_OpenCms.log(I_CmsLogChannels.C_OPENCMS_CRITICAL, "[CmsQueries] cannot get com/opencms/file/oracleplsql/query.properties");
                }
