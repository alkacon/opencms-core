 ...
 * 
 * @version $Revision: 1.1 $ $Date: 2003/05/28 09:08:29 $
 * @author 	Carsten Weinholz (c.weinholz@alkacon.com)
 */
public class CmsAccessControlEntry {

	public CmsAccessControlEntry(CmsResource resource, CmsUUID principal, int allowed, int denied) {
