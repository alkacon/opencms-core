 ...
 * @version $Revision: 1.1 $ $Date: 2001/01/30 14:03:10 $
 * @see com.opencms.workplace.CmsXmlWpTemplateFile
 */

public class CmsSyncFolder extends CmsWorkplaceDefault implements I_CmsConstants {
        ...
        if("start".equals(action)) {            
            ...
            try {              
                ...
                for(int i = numRes - 1;i >= 0;i--) {
                    ...
                    if(!checkWriteable(cms, theFolder)) {
                        ...
                        if(!(picspath.equals(theFolder) || downloadpath.equals(theFolder) 
                            ...
                            synchronizeResources.removeElementAt(i);
                        }	
                    }
                }
                ...
                if(!"error".equals(templateSelector)) {                   
                    ...
                    Thread doSyncFolder = new CmsSyncFolderThread(cms, synchronizeResources);
                    doSyncFolder.start();
