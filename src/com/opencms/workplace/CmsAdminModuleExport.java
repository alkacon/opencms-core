...
public class CmsAdminModuleExport extends CmsWorkplaceDefault {
	...
	public byte[] getContent(CmsObject cms, String templateFile, String elementName, Hashtable parameters, String templateSelector) throws CmsException {
		...
		if (step == null) {
			...
			for (Iterator it = resList.iterator(); it.hasNext(); ) {
				...
				try {
					...
					if (OpenCms.isLogging(CmsLog.CHANNEL_MODULE, CmsLog.LEVEL_WARN)) {
						OpenCms.log(CmsLog.CHANNEL_MODULE, CmsLog.LEVEL_WARN, "error exporting module: couldn't add " + res + " to Module\n" + Utils.getStackTrace(e));
					}
                    if (DEBUG > 0) {
            ...
            String filename = CmsBase.getAbsolutePath(cms.readPackagePath() + File.separator + CmsRegistry.C_MODULE_PATH + moduleName + "_" + reg.getModuleVersion(moduleName));
