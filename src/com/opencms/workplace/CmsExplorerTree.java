 ...
 * @version $Revision: 1.6 $ $Date: 2000/06/05 13:37:59 $
 */
                    ...
                    if (folder.getAbsolutePath().equals(lastFolder.getAbsolutePath())) {
                        ...
                        if (subfolders.size() >0) {
                            ...
                            if (endfolder.startsWith(folder.getAbsolutePath())) {
                                template.setData(C_TREELINK,C_WP_EXPLORER_TREE+"?"+C_PARA_FOLDER+"="+Encoder.escape(curfolder));
                                treeswitch=template.getProcessedDataValue(C_TREEIMG_MEND,this);    
                            } else {
                              template.setData(C_TREELINK,C_WP_EXPLORER_TREE+"?"+C_PARA_FOLDER+"="+Encoder.escape(folder.getAbsolutePath()));
