...
public final class CmsTouch extends CmsWorkplaceDefault implements I_CmsWpConstants, I_CmsConstants {
    ...
    public byte[] getContent( CmsObject cms, String templateFile, String elementName, Hashtable parameters, String templateSelector ) throws CmsException {               
        ...
        this.validateInput( cms, parameters );
        ...
        if (m_NewTimestamp!=-1) {
            ...
            try {
                ...
                throw new CmsException( "Redirect failed :" + getConfigFile(cms).getWorkplaceActionPath() + C_WP_EXPLORER_FILELIST, CmsException.C_UNKNOWN_EXCEPTION, e );
            }
            return null;    
        }
        
        // the form is submitted the first time, initialize the XML template
        this.initTemplate( cms, parameters, templateFile );        
            
        // pump the template with the input form out   
        return startProcessing( cms, m_XmlTemplateDocument, "", parameters, m_TemplateSection );            
    }
    
    private void validateInput( CmsObject cms, Hashtable theParameters ) throws CmsException {
    ...
    private void initTemplate( CmsObject cms, Hashtable theParameters, String theTemplateFile ) throws CmsException {
        ...
        String resourceTitle = cms.readProperty( m_Resource.getAbsolutePath(), I_CmsConstants.C_PROPERTY_TITLE);
