 ...
 * @version $Revision: 1.8 $ $Date: 2004/02/13 13:41:44 $
 */
public class CmsNewResourceXmlPage extends CmsWorkplaceDefault {
            ...
            if(step.equals("1")) {
                ...
                try {
                    ...
                    */
                    ...
                    file = ((CmsResourceTypeXmlPage)cms.getResourceType(CmsResourceTypeXmlPage.C_RESOURCE_TYPE_ID)).createResourceForTemplate(cms, currentFilelist + newFile, prop, content, templatefile);
    ...
    private byte[] ensureBodyEncoding(CmsObject cms, String bodyFilename) throws CmsException {
        ...
        if (bodyEncoding == null) {
            ...
            A_CmsXmlContent.getXmlParser().getXmlText(doc, out, OpenCms.getSystemInfo().getDefaultEncoding());
