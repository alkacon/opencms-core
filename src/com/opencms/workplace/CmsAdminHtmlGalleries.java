 ...
 *
 * @author simmeu
 * @version $Revision: 1.8 $ $Date: 2003/06/05 14:15:48 $
...
public class CmsAdminHtmlGalleries extends CmsAdminGallery {
    ...
    public byte[] getContent(CmsObject cms, String templateFile, String elementName,
        ...
        try {
            if(foldername.startsWith(C_VFS_GALLERY_HTML) && (thefolder.getParent().equals(C_VFS_GALLERY_HTML)) && templateFile.endsWith("administration_head_htmlgalleries1")) {
