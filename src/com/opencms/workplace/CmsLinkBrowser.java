 ...
 * @version $Revision: 1.12 $ $Date: 2003/08/14 15:37:24 $
...
public class CmsLinkBrowser extends CmsWorkplaceDefault {
    ...
    public byte[] getContent(CmsObject cms, String templateFile, String elementName, Hashtable parameters, String templateSelector) throws CmsException {
        if(OpenCms.isLogging(C_OPENCMS_DEBUG) && C_DEBUG) {
            OpenCms.log(C_OPENCMS_DEBUG, getClassName() + "getting content of element "
                    + ((elementName == null) ? "<root>" : elementName));
            OpenCms.log(C_OPENCMS_DEBUG, getClassName()
        ...
        if(!"error".equals(templateSelector)) {
            ...
            if(setOnClick != null){
                session.putValue("linkBrowser_for_ext_nav", setOnClick);
            }
            setOnClick = (String)session.getValue("linkBrowser_for_ext_nav");
            ...
            if(!"error_no_gallery".equals(templateSelector)) {
                ...
                Vector filteredLinks = getFilteredLinkList(cms, folder, filter);
                ...
                parameters.put("_LINKLIST_", filteredLinks);
            }
        }
    ...
    public Object linkList(CmsObject cms, String tagcontent, A_CmsXmlContent doc,
        ...
        if(folder == null || "".equals(folder)) {
            folder = C_VFS_GALLERY_EXTERNALLINKS;
        ...
        for(int i = from;i < to;i++) {
            ...
            xmlTemplateDocument.setData("linksource", linkUrl + file.getResourceName());
