...
public class CmsNewExplorerFileList implements I_CmsDumpTemplate,I_CmsConstants,I_CmsWpConstants {
    ...
    public Object getKey(CmsObject cms, String templateFile, Hashtable parameter,
        ...
        buf.append(":");
        buf.append(cms.getRequestContext().addSiteRoot(templateFile));
    ...
    public A_CmsElement createElement(CmsObject cms, String templateFile, Hashtable parameters) {
        return new CmsElementDump(getClass().getName(), templateFile, getCacheDirectives(cms, templateFile, null, parameters, null), CmsXmlTemplateLoader.getElementCache(cms).getVariantCachesize());
    }
