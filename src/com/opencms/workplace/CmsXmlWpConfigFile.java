 ...
 * @version $Revision: 1.26 $ $Date: 2001/01/24 09:43:31 $
 */
...
public class CmsXmlWpConfigFile extends A_CmsXmlContent implements I_CmsLogChannels,I_CmsConstants {
    ...
    public String getCommonPictureUrl() throws CmsException {
        ...
        if(s == null || "".equals(s)) {
            s = ((HttpServletRequest)m_cms.getRequestContext().getRequest().getOriginalRequest()).getServletPath() 
                    + getDataValue("path.commonpictures");
        }
        return s;
    }
