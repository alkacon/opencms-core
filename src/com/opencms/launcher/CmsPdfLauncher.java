 ...
 * @version $Revision: 1.1 $ $Date: 2000/06/05 15:51:30 $
 */
public class CmsPdfLauncher extends CmsXmlLauncher { 	
    ...
    protected void launch(A_CmsObject cms, CmsFile file, String startTemplateClass, A_OpenCms openCms) throws CmsException {
		...
		//out.write(templatedata,0,templatedata.length);
		//A_OpenCms.log(C_OPENCMS_CRITICAL, "[CmsPdfLauncher] TEMPLATEDATA: " + out.toString());
