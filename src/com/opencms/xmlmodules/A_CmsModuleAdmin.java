...
public abstract class A_CmsModuleAdmin extends CmsWorkplaceDefault implements I_CmsConstants,I_CmsModuleConstants,I_CmsFileListUsers {
     ...
     */
    protected abstract A_CmsModuleObject createFile(CmsObject cms, String fileName) throws CmsException;
     ...
     * @exception CmsException
     */
    protected abstract void createPageFile(CmsObject cms, String fileName, String mastertemplate) throws CmsException;
     ...
     */
    protected abstract A_CmsModuleObject getContentFile(CmsObject cms, CmsResource file) throws CmsException;
