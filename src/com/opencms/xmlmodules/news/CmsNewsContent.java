...
public class CmsNewsContent extends A_CmsModuleContent implements I_CmsNewsConstants {
	 ...
	 */
	protected Vector getFileObjects(CmsObject cms, Vector sortedFiles, boolean showInactive) 
			throws CmsException {
	 ...
	 */
	public String getTagContent(CmsObject cms, String tagcontent, A_CmsXmlContent doc, Object userObj) 
			throws CmsException {
	 ...
	 * @return List of all articles.
	 */
	protected String getWapData(CmsXmlTemplateFile template, Vector v, int selection, boolean isNavDeck) 
			throws CmsException {
		String result="";
