 ...
 * @version $Revision: 1.6 $ $Date: 2001/01/24 09:43:48 $
...
public class CmsNewsAdmin extends A_CmsModuleAdmin implements I_CmsNewsConstants {
     ...
     */
    protected A_CmsModuleObject createFile(CmsObject cms, String fileName) throws CmsException {
     ...
     * @exception CmsException
     */
    protected void createPageFile(CmsObject cms, String fileName, String mastertemplate) throws CmsException {
     ...
     */
    protected void setFileContent(CmsNewsObject obj, I_CmsSession session, Hashtable parameters) throws CmsException {
