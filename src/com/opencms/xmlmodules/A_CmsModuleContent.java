 ...
 * @version $Revision: 1.5 $ $Date: 2001/01/24 09:43:48 $
...
public abstract class A_CmsModuleContent extends CmsXmlTemplate implements I_CmsModuleConstants,I_CmsLogChannels {
     ...
     */
    public String getArticleList(CmsObject cms, String tagcontent, A_CmsXmlContent doc, Object userObj) throws CmsException {
     ...
     */
    public abstract byte[] getContent(CmsObject cms, String templateFile, String elementName, Hashtable parameters, String templateSelector) throws CmsException;
     ...
     */
    protected abstract Vector getFileObjects(CmsObject cms, Vector sortedFiles, boolean showInactive) throws CmsException;
     ...
     * @return List of all articles.
     */
    protected abstract String getListData(CmsXmlTemplateFile template, Vector v, String servletPath, Object userObj) throws CmsException;
     ...
     */
    public abstract String getTagContent(CmsObject cms, String tagcontent, A_CmsXmlContent doc, Object userObj) throws CmsException;
     ...
     */
    public String getWapContent(CmsObject cms, String tagcontent, A_CmsXmlContent doc, Object userObj) throws CmsException {
        Hashtable parameters = (Hashtable)userObj;
        String elementName = (String)parameters.get("_ELEMENT_");
        String result = "";
        CmsXmlTemplateFile templateFile = (CmsXmlTemplateFile)doc;
     ...
     * @return List of all articles.
     */
    protected abstract String getWapData(CmsXmlTemplateFile template, Vector v, int selection, boolean isNavDeck) throws CmsException;
     ...
     */
    public String getWapTitle(CmsObject cms, String tagcontent, A_CmsXmlContent doc, Object userObj) throws CmsException {
        Hashtable parameters = (Hashtable)userObj;
        String elementName = (String)parameters.get("_ELEMENT_");
