 ...
 * 
 * @author $Author: m.meurer $
 * @version $Name:  $ $Revision: 1.6 $ $Date: 2001/01/24 09:42:14 $
...
public class CmsExampleNavigation extends CmsXmlTemplate implements I_CmsConstants {
     ...
     */
    public Object getHead(CmsObject cms, String tagcontent, A_CmsXmlContent doc, Object userObject) throws CmsException {
     ...
     * @exception CmsException
     */
    public Object getNav(CmsObject cms, String tagcontent, A_CmsXmlContent doc, Object userObject) throws CmsException {
        CmsXmlTemplateFile xmlDataBlock = (CmsXmlTemplateFile)doc;
        String frame = "";
        if((((Hashtable)userObject).get("cmsframe")) != null) {
            frame = (((Hashtable)userObject).get("cmsframe")).toString();
        ...
        String[] linkFile =  {
            "neuigkeit1.html", "neuigkeit2.html", "index.html"
        };
        String[] linkText =  {
            "Topthemen", "Themen des Tages", "Startseite"
        };
        StringBuffer result = new StringBuffer();
        for(int i = 0;i < 3;i++) {
            if(frame.equals("plain")) {
     ...
     * @exception CmsException
     */
    public String getNavPath(CmsObject cms) throws CmsException {
