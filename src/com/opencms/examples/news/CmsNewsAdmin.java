 ...
 * @version $Revision: 1.21 $ $Date: 2001/01/24 09:42:14 $
...
public class CmsNewsAdmin extends CmsWorkplaceDefault implements I_CmsConstants,I_CmsNewsConstants,I_CmsFileListUsers {
    ...
    //cms.unlockResource(fullFilename); causes trouble!
    }
    ...
    public byte[] getContent(CmsObject cms, String templateFile, String elementName, Hashtable parameters, String templateSelector) throws CmsException {
        ...
        if("edit".equals(action)) {
            ...
            if(newHeadline == null && newShorttext == null && newText == null && newExternalLink == null) {
                ...
                //cms.unlockResource(newsContentFile.getAbsoluteFilename()); causes trouble!                                                                                            
     ...
     */
    public void getCustomizedColumnValues(CmsObject cms, CmsXmlWpTemplateFile filelistTemplate, CmsResource res, CmsXmlLanguageFile lang) throws CmsException {
        ...
        if(res instanceof CmsFile) {
            ...
            state = newsContentFile.isNewsActive() ? lang.getLanguageValue(C_LANG_LABEL + "." + C_NEWS_STATE_ACTIVE) : lang.getLanguageValue(C_LANG_LABEL 
                    + "." + C_NEWS_STATE_INACTIVE);
            author = Encoder.escapeXml(newsContentFile.getNewsAuthor());
            name = Encoder.escapeXml(newsContentFile.getNewsHeadline());
        }
     ...
     * @exception Throws CmsException if something goes wrong.
     */
    public Integer getStates(CmsObject cms, CmsXmlLanguageFile lang, Vector names, Vector values, Vector descriptions, Hashtable parameters) throws CmsException {
    ...
    private void makeTask(CmsObject cms, String newsFileName, String taskuser, String taskgroup) throws CmsException {
        ...
        CmsTaskAction.create(cms, taskuser, taskgroup, lang.getLanguageValue("task.label.news"), taskcomment, Utils.getNiceShortDate(new Date().getTime() 
                + 345600000), "1", "", "", "", "");
    }
     ...
     */
    private void setNewsFileContent(CmsNewsContentFile newsFile, String author, String date, String headline, String shorttext, 
            String text, String extlink, String state) throws CmsException {
