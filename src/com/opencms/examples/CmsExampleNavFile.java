 ...
 * @version $Revision: 1.5 $ $Date: 2001/01/24 09:42:14 $
 */
public class CmsExampleNavFile extends CmsXmlTemplateFile {
    ...
    public String getCurrentSectionNavEntry(String link, String title) throws CmsException {
        return getDataValue("currentsection.startseq") + link + getDataValue("currentsection.middleseq") 
                + title + getDataValue("currentsection.endseq") + "\n";
    }
    ...
    public String getOtherSectionNavEntry(String link, String title) throws CmsException {
        return getDataValue("section.startseq") + link + getDataValue("section.middleseq") + title 
                + getDataValue("section.endseq") + "\n";
    }
