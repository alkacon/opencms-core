/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/repository/cms/Attic/Messages.java,v $
...
public final class Messages extends A_CmsMessageBundle {
    ...
    public static final String ERR_COPY_FAILED_0 = "ERR_COPY_FAILED_0";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_DELETE_FAILED_0 = "ERR_DELETE_FAILED_0";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_DEST_EXISTS_0 = "ERR_DEST_EXISTS_0";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_LIST_FAILED_0 = "ERR_LIST_FAILED_0";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_LOCK_FAILED_0 = "ERR_LOCK_FAILED_0";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_MOVE_FAILED_0 = "ERR_MOVE_FAILED_0";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_OVERWRITE_0 = "ERR_OVERWRITE_0";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_READ_FAILED_0 = "ERR_READ_FAILED_0";

    /** Message constant for key in the resource bundle. */
    public static final String ERR_SAVE_FAILED_0 = "ERR_SAVE_FAILED_0";
    ...
    private static final String BUNDLE_NAME = "org.opencms.repository.cms.messages";
