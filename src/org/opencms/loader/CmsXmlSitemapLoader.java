/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/loader/Attic/CmsXmlSitemapLoader.java,v $
...
/**
 * OpenCms loader for resources of type <code>{@link org.opencms.file.types.CmsResourceTypeXmlSitemap}</code>.<p>
 *
 ...
 * @since 7.6
 */
public class CmsXmlSitemapLoader extends A_CmsXmlDocumentLoader {

    /** The id of this loader. */
    public static final int RESOURCE_LOADER_ID = 12;

    /**
     * Default constructor.<p>
     */
    public CmsXmlSitemapLoader() {
     ...
     * <code>"The OpenCms default resource loader for sitemaps"</code>.<p>
     * 
     * @return a describing String for the ResourceLoader 
     */
    public String getResourceLoaderInfo() {

        return Messages.get().getBundle().key(Messages.GUI_LOADER_SITEMAP_DEFAULT_DESC_0);
    }
    ...
    throws CmsException {
        ...
        return CmsXmlSitemapFactory.unmarshal(cms, resource, req);
    }
}
