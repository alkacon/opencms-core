...
public abstract class A_CmsSerialDateValue implements I_CmsSerialDateValue {
     ...
     */
    protected void addWeekOfMonth(WeekOfMonth week) {
     ...
     */
    protected void clearIndividualDates() {
     ...
     */
    protected void clearWeeksOfMonth() {
     ...
     */
    protected void removeWeekOfMonth(WeekOfMonth week) {
     ...
     */
    protected void setEndType(EndType endType) {
     ...
     */
    protected void setEveryWorkingDay(Boolean isEveryWorkingDay) {
     ...
     */
    protected void setExceptions(SortedSet<Date> dates) {
     ...
     */
    protected void setIndividualDates(SortedSet<Date> dates) {
     ...
     */
    protected void setPatternType(PatternType type) {
     ...
     */
    protected void setSeriesEndDate(Date date) {
     ...
     */
    protected void setWeekDay(WeekDay weekDay) {
     ...
     */
    protected void setWeekDays(SortedSet<WeekDay> weekDays) {
     ...
     */
    protected void setWeekOfMonth(WeekOfMonth weekOfMonth) {
     ...
     */
    protected void setWeeksOfMonth(SortedSet<WeekOfMonth> weeksOfMonth) {
     ...
     */
    protected void setWholeDay(Boolean isWholeDay) {
