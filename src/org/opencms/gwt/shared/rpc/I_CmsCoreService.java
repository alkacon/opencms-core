...
public interface I_CmsCoreService extends RemoteService {
    ...
    */
     ...
     * @throws CmsRpcException if something goes wrong
     */
    List<CmsContextMenuEntryBean> getContextMenuEntries(CmsUUID structureId, AdeContext context, String subContext)
    throws CmsRpcException;
     ...
     * @param linkMode the workplace link mode
     *
     ...
     * @throws CmsRpcException if something goes wrong
     */
    String getWorkplaceLink(CmsUUID structureId, CmsWorkplaceLinkMode linkMode) throws CmsRpcException;
