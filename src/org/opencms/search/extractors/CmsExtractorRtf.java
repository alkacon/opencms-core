...
public final class CmsExtractorRtf extends A_CmsTextExtractor {
    ...
    private static final CmsExtractorRtf INSTANCE_METADATA = new CmsExtractorRtf(true);

    /** Static member instance of the extractor. */
    private static final CmsExtractorRtf INSTANCE_NO_METADATA = new CmsExtractorRtf(false);
     ...
     */
    private CmsExtractorRtf(boolean extractMetaData) {
    ...
    public I_CmsExtractionResult extractText(InputStream in) throws Exception {
        ...
        return extractText(in, new RTFParser(), m_extractMetaData);
    }
}