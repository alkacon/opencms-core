...
public class CmsGallerySolrFieldConfiguration extends CmsSolrFieldConfiguration {
    ...
    protected I_CmsSearchDocument appendFieldMappings(
        ...
        Iterator<CmsSolrField> fieldConfigs = getSolrFields().values().iterator();
        while (fieldConfigs.hasNext()) {
            // check all field configurations 
            CmsSolrField fieldConfig = fieldConfigs.next();
    ...
    protected I_CmsSearchDocument appendMultipleFieldMapping(
        ...
        for (Locale locale : OpenCms.getLocaleManager().getAvailableLocales()) {
            ...
            if ((value != null) && (field instanceof CmsLuceneField)) {
                ...
                s.setName(getLocaleExtendedName(fieldName, locale));
