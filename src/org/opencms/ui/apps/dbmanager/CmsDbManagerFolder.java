 ...
 */
public class CmsDbManagerFolder implements I_CmsFolderAppCategory {

    /**Folder id.*/
    public static final String ID = "db-manager";

    /** The app icon resource (size 32x32). */
    public static final CmsCssIcon ICON = new CmsCssIcon("oc-icon-32-database");
