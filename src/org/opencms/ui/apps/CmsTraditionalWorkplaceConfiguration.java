 ...
 */
public class CmsTraditionalWorkplaceConfiguration extends A_CmsWorkplaceAppConfiguration {
    ...
    public String getHelpText(Locale locale) {
        ...
        return Messages.get().getBundle(locale).key(Messages.GUI_WORKPLACE_HELP_0);
    }
    ...
    public String getName(Locale locale) {
        ...
        return Messages.get().getBundle(locale).key(Messages.GUI_WORKPLACE_TITLE_0);
    }
