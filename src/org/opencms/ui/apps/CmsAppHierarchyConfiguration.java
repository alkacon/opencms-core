 ...
 */
public class CmsAppHierarchyConfiguration extends A_CmsWorkplaceAppConfiguration implements I_CmsHasADEQuickLaunchData {
        ...
        if (!settings.usesNewWorkplace() || !getVisibility(cms).isActive()) {
            ...
            return Optional.of(
                new CmsQuickLaunchData(
                    Q_LAUNCHPAD,
                    OpenCms.getSystemInfo().getWorkplaceContext() + "#!" + APP_ID,
    ...
    public String getImageLink() {
        ...
        return OpenCmsTheme.getImageLink("apps/launchpad.png");
    }
