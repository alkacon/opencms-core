...
public class CmsEditCodeDialogAction extends A_CmsWorkplaceAction {
    ...
    private static final Log LOG = CmsLog.getLog(CmsEditCodeDialogAction.class);

    /** The action id. */
    public static final String ACTION_ID = "editcode";

    /** The action visibility. */
    public static final I_CmsHasMenuItemVisibility VISIBILITY = CmsStandardVisibilityCheck.EDIT_CODE;
    ...
    public String getTitle() {
        ...
        return getWorkplaceMessage(Messages.GUI_EXPLORER_CONTEXT_EDITCONTROLFILE_0);
    }
