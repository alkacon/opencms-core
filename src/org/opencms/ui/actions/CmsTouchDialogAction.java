 ...
 */
public class CmsTouchDialogAction extends A_CmsWorkplaceAction {

    /** The action id. */
    public static final String ACTION_ID = "touch";
    ...
    public void executeAction(I_CmsDialogContext context) {
        ...
        if (!hasBlockingLocks(context)) {
            openDialog(new CmsTouchDialog(context), context);
        }
    }
    ...
    public String getDialogTitle() {
        ...
        return CmsVaadinUtils.getMessageText(org.opencms.ui.Messages.GUI_DIALOGTITLE_TOUCH_0);
    }
    ...
    public String getTitle() {
        ...
        return getWorkplaceMessage(Messages.GUI_EXPLORER_CONTEXT_TOUCH_0);
    }
