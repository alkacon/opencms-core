...
/**
 * Action to preview resources.<p>
 * Used within the ADE context only.<p>
 */
public class CmsWorkplaceAction extends A_CmsWorkplaceAction implements I_CmsADEAction {

    /** The action id. */
    public static final String ACTION_ID = "workplace";
    ...
    public CmsMenuItemVisibilityMode getVisibility(I_CmsDialogContext context) {
        ...
        return AdeContext.editprovider.name().equals(context.getAppId())
    ...
    protected String getTitleKey() {
        ...
        return Messages.GUI_EXPLORER_CONTEXT_SHOW_WORKPLACE_0;
    }
}
