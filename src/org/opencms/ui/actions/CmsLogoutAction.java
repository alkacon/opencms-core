 ...
 */
public class CmsLogoutAction extends A_CmsWorkplaceAction implements I_CmsADEAction {

    /** The action id. */
    public static final String ACTION_ID = "logout";
    ...
    public String getCommandClassName() {
        ...
        return "org.opencms.gwt.client.ui.contextmenu.CmsLogout";
    }
    ...
    public CmsMenuItemVisibilityMode getVisibility(I_CmsDialogContext context) {
        ...
        boolean visible = AdeContext.editprovider.name().equals(context.getAppId());
    ...
    protected String getTitleKey() {
        ...
        return Messages.GUI_EXPLORER_CONTEXT_LOGOUT_0;
    }
}
