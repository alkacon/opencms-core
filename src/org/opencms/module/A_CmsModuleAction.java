...
public abstract class A_CmsModuleAction implements I_CmsModuleAction {
    ...
    public void cmsEvent(CmsEvent event) {
        ...
        if (OpenCms.getLog(this).isDebugEnabled()) {
            OpenCms.getLog(this).debug(this.getClass().getName() + " caugth evevnt: " + event.getType());
        }
    }
    ...
    public void initialize(CmsObject adminCms) {
        ...
        if (OpenCms.getLog(this).isDebugEnabled()) {
            OpenCms.getLog(this).debug(this.getClass().getName() + " initialized");
        }      
    }
    
    /**
     * @see org.opencms.module.I_CmsModuleAction#moduleUninstall()
     */
    public void moduleUninstall() {

        if (OpenCms.getLog(this).isDebugEnabled()) {
            OpenCms.getLog(this).debug(this.getClass().getName() + " uninstalled");
        }        
    }    
    ...
    public void moduleUpdate(CmsModule module) {
        ...
        if (OpenCms.getLog(this).isDebugEnabled()) {
            OpenCms.getLog(this).debug(this.getClass().getName() + " updated");
        }         
    }    
    ...
    /**
     * @see org.opencms.module.I_CmsModuleAction#shutDown()
     */
    public void shutDown() {

        if (OpenCms.getLog(this).isDebugEnabled()) {
            OpenCms.getLog(this).debug(this.getClass().getName() + " shutting down");
        }         
    }
}
