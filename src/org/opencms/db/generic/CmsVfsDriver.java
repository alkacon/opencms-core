...
public class CmsVfsDriver extends Object implements I_CmsVfsDriver {
	...
	protected CmsFile createCmsFileFromResultSet(ResultSet res, int projectId, boolean hasFileContentInResultSet) throws SQLException, CmsException {                          
        ...
        return new CmsFile(structureId, resourceId, parentId, fileId, resourceName, resourceType, resourceFlags, resProjectId, 0, newState, lockedBy, launcherType, dateCreated, userCreated, newDateLastModified, newUserLastModified, content, resourceSize, lockedInProject);
    }
    ...
    public CmsFolder createCmsFolderFromResultSet(ResultSet res, int projectId, boolean hasProjectIdInResultSet) throws SQLException {
        ...
        return new CmsFolder(structureId, resourceId, parentId, fileId, resourceName, resourceType, resourceFlags, resProjectId, 0, structureState, lockedBy, dateCreated, userCreated, dateLastModified, userLastModified, lockedInProject);
    }
    ...
    public CmsResource createCmsResourceFromResultSet(ResultSet res, int projectId) throws SQLException, CmsException {
        ...
        CmsResource newResource = new CmsResource(structureId, resourceId, parentId, fileId, resourceName, resourceType, resourceFlags, resourceProjectId, 0, newState, lockedBy, launcherType, dateCreated, userCreated, newDateLastModified, newUserLastModified, resourceSize, lockedInProject);
    ...
    public CmsFile createFile(CmsProject project, CmsFile file, CmsUUID userId, CmsUUID parentId, String filename) throws CmsException {
        ...
        Connection conn = null;
        PreparedStatement stmt = null;
        boolean contentExistsAlready = false;
        ...
        try {
            ...
            if (!existsResource(project, file)) { 
                ...
                // update the resource and content records
    ...
    private boolean existsResource (CmsProject project, CmsResource resource) throws CmsException {
        ...
        try {
            conn = m_sqlManager.getConnection(project);
            stmt = m_sqlManager.getPreparedStatement(conn, project, "C_RESOURCES_READ_RESOURCE_STATE");
    ...
    private int countVfsLinks (CmsProject project, CmsResource resource) throws CmsException {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet res = null; 
        int count = 0;
        ...
        try {
            conn = m_sqlManager.getConnection(project);
            stmt = m_sqlManager.getPreparedStatement(conn, project, "C_RESOURCES_COUNTLINKS"); 
            stmt.setString(1, resource.getResourceId().toString());
            res = stmt.executeQuery();
    ...
    public CmsFolder createFolder(CmsUser user, CmsProject project, CmsFolder folder, CmsUUID parentId, String foldername) throws CmsException {
        ...
        try {
            ...
            stmt.setInt(5, 0 /* folder.getVfsLinkType() */);
            stmt.setInt(6, state);
            stmt.setTimestamp(7, new Timestamp(dateModified));
            stmt.setString(8, modifiedByUserId.toString());
  ...
  public CmsResource importResource(CmsProject project, CmsUUID parentId, CmsResource newResource, byte[] filecontent, CmsUUID userId, boolean isFolder) throws CmsException {
      ...
      try {
          ...
          stmt.setInt(5, 0 /* newResource.getVfsLinkType() */);
          stmt.setInt(6, state);
    ...
    public void removeFile(CmsProject currentProject, CmsResource resource) throws CmsException {
        ...
        try {
            ...
            // todo: check this based on ref count later
            if (this.countVfsLinks(currentProject, resource) == 0) { 
    ...
    */
    public void writeFileHeader(CmsProject project, CmsFile file, int changed, CmsUUID userId) throws CmsException {
        ...
        try {
            ...
            stmt.setString(2, file.getResourceName());
            stmt.setInt(3, 0 /* file.getVfsLinkType() */);
            stmt.setInt(4, structureState);
            stmt.setTimestamp(5, new Timestamp(structureDateModified));
            stmt.setString(6, userId.toString());
            stmt.setString(7, file.getId().toString());
            stmt.executeUpdate();          
    ...
    */
    public void writeFolder(CmsProject project, CmsFolder folder, int changed, CmsUUID userId) throws CmsException {
        ...
        try {
            ...
            stmt.setInt(7, 0 /* folder.getVfsLinkType() */);
            ...
            stmt.setString(2, folder.getResourceName());
            stmt.setInt(3, 0 /* folder.getVfsLinkType() */);            
			stmt.setInt(4, resourceState);
            stmt.setTimestamp(5, new Timestamp(structureDateModified));               
            stmt.setString(6, userId.toString());
            stmt.setString(7, folder.getId().toString());                       
            stmt.executeUpdate();
    ...
    */
    public void writeResource(CmsProject project, CmsResource resource, byte[] filecontent, int changed, CmsUUID userId) throws CmsException {
        ...
        try {
            ...
            stmt.setInt(3, 0 /* resource.getVfsLinkType() */);
			stmt.setInt(4, structureState);
            stmt.setTimestamp(5, new Timestamp(structureDateModified));
            stmt.setString(6, userId.toString());
            stmt.setString(7, resource.getId().toString());
            stmt.executeUpdate();
    ...
    public void publishResource(CmsResource onlineResource, CmsResource offlineResource, boolean writeContent) throws CmsException {
        ...
        try {
            ...
            if (offlineResource instanceof CmsFile) {
                ...
                if (writeContent) {
                    writeFileContent(onlineResource.getFileId(), ((CmsFile)offlineResource).getContents(), I_CmsConstants.C_PROJECT_ONLINE_ID, false);    
                }
            }
            ...
            stmt.setString(2, offlineResource.getResourceName());
            stmt.setInt(3, 0 /* offlineResource.getVfsLinkType() */);            
            ...
            stmt.setString(7, offlineResource.getId().toString());                       
            stmt.executeUpdate();
    ...
    public void moveResource(CmsUser currentUser, CmsProject currentProject, CmsResource resource, CmsResource destinationFolder, String resourceName) throws CmsException {
        ...
        try {
            ...
            stmt.setInt(5, 0 /* resource.getVfsLinkType() */);
