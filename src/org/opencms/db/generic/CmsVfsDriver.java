 ...
 * Date   : $Date: 2007/05/02 16:39:52 $
 * Version: $Revision: 1.258.4.18 $
 *
...
public class CmsVfsDriver implements I_CmsDriver, I_CmsVfsDriver {
    ...
    throws CmsDataAccessException {
        ...
        try {
            ...
            if (projectId.equals(CmsProject.ONLINE_PROJECT_ID)) {
                ...
                stmt = m_sqlManager.getPreparedStatement(conn, projectId, "C_ONLINE_CONTENTS_WRITE");
            } else {
                // create new offline content
                stmt = m_sqlManager.getPreparedStatement(conn, projectId, "C_OFFLINE_CONTENTS_WRITE");
            }
            stmt.setString(1, resourceId.toString());
    ...
    throws CmsDataAccessException {
        ...
        try {
            ...
            queryBuf.append(" ORDER BY RELATION_SOURCE_PATH, RELATION_TARGET_PATH, RELATION_TYPE ASC");
            stmt = m_sqlManager.getPreparedStatementForSql(conn, queryBuf.toString());
