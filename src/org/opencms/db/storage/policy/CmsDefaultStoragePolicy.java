 ...
 * storage. It uses a rule-based engine to check the resource type and file
 * size.<p>
 *
 ...
 * <li><b>Storage Rules:</b> If any storage rule matches (e.g., binary or image files above the configured threshold), it is offloaded.</li>
            ...
            new CmsStoragePolicyEngine.AndRule(
                ...
                context -> {
                    ...
                    return Boolean.valueOf(
                        (CmsResourceTypeImage.getStaticTypeId() == typeId)
                            || (CmsResourceTypeBinary.getStaticTypeId() == typeId));
                }));
    }
}
