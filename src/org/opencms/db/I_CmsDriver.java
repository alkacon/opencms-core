...
/**
 * @version $Revision: 1.3 $ $Date: 2003/08/20 10:25:08 $
...
public interface I_CmsDriver {
     ...
     */
    void init(Configurations config, List successiveDrivers, CmsDriverManager driverManager) throws CmsException;
