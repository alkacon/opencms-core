/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/db/jpa/persistence/CmsDAOOfflineAccessControl.java,v $
...
/**
 * This data access object represents a access control entry inside the table "cms_offline_accesscontrol".<p>
 * 
...
public class CmsDAOOfflineAccessControl implements I_CmsDAOAccessControl {
    ...
    /**
     * This class implements the primary key for a access control entry in the table "cms_offline_accesscontrol".<p>
     */
    ...
    /**
     * A public constructor for generating a new access control object with an unique id.<p>
     * 
