/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/db/jpa/utils/CmsQueryLongParameter.java,v $
 ...
 * @since 8.0.0
 */
public class CmsQueryLongParameter implements I_CmsQueryParameter {
    ...
    public void insertIntoQuery(Query q, int index) throws PersistenceException {
        ...
        q.setParameter(index, Long.valueOf(m_param));
    }
}
