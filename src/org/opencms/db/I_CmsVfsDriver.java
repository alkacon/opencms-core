...
public interface I_CmsVfsDriver {
    ...
    void publishResource(
        ...
        boolean writeFileContent) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    CmsFile readFile(CmsDbContext dbc, int projectId, boolean includeDeleted, CmsUUID structureId) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    List readFiles(CmsDbContext dbc, int projectId) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    List readFiles(CmsDbContext dbc, int projectId, int resourcetype) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    CmsFolder readFolder(CmsDbContext dbc, int projectId, CmsUUID folderId) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    CmsFolder readFolder(CmsDbContext dbc, int projectId, String foldername) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    List readFolders(CmsDbContext dbc, int projectId) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    List readPropertyObjects(CmsDbContext dbc, CmsProject project, CmsResource resource) throws CmsException;
     ...
     * @throws CmsException if somethong goes wrong
     */
    List readResources(CmsDbContext dbc, int currentProject, int state, int mode) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    void removeFolder(CmsDbContext dbc, CmsProject currentProject, CmsResource resource) throws CmsException;
    ...
    void replaceResource(
        ...
        CmsResource res,
        byte[] newResContent,
        int newResType) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    boolean validateContentIdExists(CmsDbContext dbc, int projectId, CmsUUID contentId) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    boolean validateResourceIdExists(CmsDbContext dbc, int projectId, CmsUUID resourceId) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    boolean validateStructureIdExists(CmsDbContext dbc, int projectId, CmsUUID structureId) throws CmsException;
     ...
     * @throws CmsException if something goes wrong
     */
    void writeContent(CmsDbContext dbc, CmsProject project, CmsUUID resourceId, byte[] content) throws CmsException;
     ...
     */
    void writeResource(CmsDbContext dbc, CmsProject project, CmsResource resource, int changed) throws CmsException;
