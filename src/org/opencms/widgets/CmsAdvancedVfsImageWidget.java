/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/widgets/Attic/CmsAdvancedVfsImageWidget.java,v $
...
/**
 * Provides a widget for an extended image selection using the advanced image gallery. <p>
 */
public class CmsAdvancedVfsImageWidget extends A_CmsWidget {

    // TODO: replace contants through enumeration
     ...
     */
    public CmsAdvancedVfsImageWidget() {
     ...
     */
    public CmsAdvancedVfsImageWidget(String configuration) {
    ...
    public String getDialogIncludes(CmsObject cms, I_CmsWidgetDialog widgetDialog) {
        ...
        result.append(getJSIncludeFile(CmsWorkplace.getSkinUri() + "components/widgets/advancedvfsimage.js"));
    ...
    public String getDialogInitCall(CmsObject cms, I_CmsWidgetDialog widgetDialog) {
        ...
        return "\tinitAdvancedVfsImageGallery();\n";
    }
    ...
    public String getDialogInitMethod(CmsObject cms, I_CmsWidgetDialog widgetDialog) {
        ...
        result.append("function initAdvancedVfsImageGallery() {\n");
        result.append("\t");
        result.append("advancedVfsImageGalleryPath = \"");
    ...
    public String getDialogWidget(CmsObject cms, I_CmsWidgetDialog widgetDialog, I_CmsWidgetParameter param) {
        ...
        CmsAdvancedVfsImageWidgetConfiguration configuration = new CmsAdvancedVfsImageWidgetConfiguration(
            cms,
            widgetDialog,
            param,
            getConfiguration());
        ...
        result.append(widgetDialog.button("javascript:openAdvancedVfsImageGallery('"
        ...
        result.append(widgetDialog.button("javascript:previewAdvancedVfsImage('"
            + id
            + "', '"
            + idHash
            + "');return false;", null, "preview.png", Messages.GUI_BUTTON_PREVIEW_0, widgetDialog.getButtonStyle()));
    ...
    public I_CmsWidget newInstance() {
        ...
        return new CmsAdvancedVfsImageWidget(getConfiguration());
    }
