 ...
 * @since 6.0.0
 */
public class CmsLegacyLinkGalleryWidget extends A_CmsGalleryWidget {

    /**
     * Creates a new external link gallery widget.<p>
     */
    public CmsLegacyLinkGalleryWidget() {
     ...
     */
    public CmsLegacyLinkGalleryWidget(String configuration) {
    ...
    public String getWidgetName() {
        ...
        return CmsLegacyLinkGalleryWidget.class.getName();
    }
    ...
    public I_CmsWidget newInstance() {
        ...
        return new CmsLegacyLinkGalleryWidget(getConfiguration());
    }
