 ...
 * @since 5.7.2 
 * 
 * @see org.opencms.file.CmsResource#getComparatorKey()
 * @see org.opencms.file.CmsResource#setComparatorKey(Object)
 */
public class CmsPriorityDateResourceComparator implements Comparator {
    ...
    private static CmsPriorityDateResourceComparator create(CmsResource resource, CmsObject cms) {
        ...
        CmsPriorityDateResourceComparator result = new CmsPriorityDateResourceComparator(null);
