...
public interface I_CmsResourceType extends I_CmsConfigurationParameterHandler {
    ...
    /**
     * Returns the default for the <code>cache</code> property setting for this resource type.<p>
     * 
     * The <code>cache</code> property is used by the Flex cache implementation to
     * control the caching behaviour of a resource.<p>
     * 
     * If <code>null</code> is returnd, this is the same as turning the cache 
     * off by default.<p>
     * 
     * @return the default for the <code>cache</code> property setting for this resource type
     */
     ...
     * @throws CmsException if something goes wrong
     */
    void restoreResource(CmsObject cms, int tag, String resourcename) throws CmsException;
