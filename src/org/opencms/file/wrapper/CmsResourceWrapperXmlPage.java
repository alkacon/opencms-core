...
public class CmsResourceWrapperXmlPage extends A_CmsResourceWrapper {
    ...
    /**
     * @see org.opencms.file.wrapper.A_CmsResourceWrapper#copyResource(org.opencms.file.CmsObject, java.lang.String, java.lang.String, int)
     */
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                if (key.endsWith(SUFFIX_SHARED)) {
                    ...
                    propList.add(new CmsProperty(key.substring(0, key.length() - SUFFIX_INDIVIDUAL.length()), value, null));
                }
            }
