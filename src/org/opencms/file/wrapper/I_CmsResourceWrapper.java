...
public interface I_CmsResourceWrapper {
     ...
     */
    boolean copyResource(CmsObject cms, String source, String destination, int siblingMode)
     ...
     */
    boolean deleteResource(CmsObject cms, String resourcename, int siblingMode) throws CmsException;
