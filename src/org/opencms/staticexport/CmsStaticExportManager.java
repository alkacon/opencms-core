...
public class CmsStaticExportManager implements I_CmsEventListener {
    ...
    /** internal timestamp for writing data into the db */
    ...
    /**
     * Returns the current export timestamp.<p>
     * 
     * @return the current export timestamp.
     */
