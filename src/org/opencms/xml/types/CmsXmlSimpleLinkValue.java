...
public class CmsXmlSimpleLinkValue extends A_CmsXmlContentValue implements I_CmsXmlContentValue {
     ...
     */
    public CmsXmlSimpleLinkValue(Element element, String name, int index) {
     ...
     */
    public CmsXmlSimpleLinkValue(String name) {
     ...
     */
    public CmsXmlSimpleLinkValue(String name, int minOccurs, int maxOccurs) {
    ...
    public I_CmsXmlContentValue createValue(Element element, String name, int index) {
        ...
        return new CmsXmlSimpleLinkValue(element, name, index);
    }
