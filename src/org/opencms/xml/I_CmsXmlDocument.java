...
public interface I_CmsXmlDocument {
     ...
     * 
     * The file may not be available if the document was generated by a String or a pure XML document.<p>
     * 
    ...
    /**
     * Initializes this XML document, required after structural changes to the XML.<p>
     * 
