/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/workplace/commons/CmsDeleteBrokenRelationsCollector.java,v $
...
public class CmsDeleteBrokenRelationsCollector extends A_CmsListResourceCollector {
    ...
    protected void setAdditionalColumns(CmsListItem item, CmsResourceUtil resUtil) {
        ...
        item.set(CmsDeleteBrokenRelationsList.LIST_COLUMN_ROOT_PATH, resUtil.getPath());
