 ...
 * workplace classes and elements. <p>
 *
...
public interface I_CmsWpConstants {
    ...
    String[] C_SELECTBOX_EDITORVIEWS = {"edithtml", "edit"};

    /** values for editor view select boxes. */
    int[] C_SELECTBOX_EDITORVIEWS_ALLOWED = {3, 2};

    /** templates of the different option values for editor view select boxes. */
    String[] C_SELECTBOX_EDITORVIEWS_TEMPLATES = {"edit_html_main", "edit_text_main"};

    /** default selected option value for editor view select boxes. */
    int[] C_SELECTBOX_EDITORVIEWS_DEFAULT = {0, 1};
