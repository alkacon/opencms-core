...
public class CmsXmlDownloadGalleryWidget extends A_CmsXmlWidget {
    ...
    public String getDialogInitMethod(
        ...
        result.append(CmsGallery.C_PATH_GALLERIES + CmsGallery.C_OPEN_URI_SUFFIX + "?" + CmsGallery.PARAM_GALLERY_TYPENAME + "=downloadgallery");
        result.append("\";\n");
        result.append("}\n");        
    ...
    public String getDialogWidget(
        ...
        result.append(widgetDialog.button("javascript:openDownloadSelector('" + CmsGallery.MODE_WIDGET + "',  '" + id + "');", null, "downloadgallery", "button.downloadlist", widgetDialog.getSettings().getUserSettings().getEditorButtonStyle()));
