...
public class CmsXmlImageGalleryWidget extends A_CmsXmlWidget {
    ...
    public String getDialogWidget(
        ...
        result.append(widgetDialog.button("javascript:openImageGallery('" + A_CmsGallery.MODE_WIDGET + "',  '" + id + "');", null, "imagegallery", "button.imagelist", widgetDialog.getSettings().getUserSettings().getEditorButtonStyle()));
