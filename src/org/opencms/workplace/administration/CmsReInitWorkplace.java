/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/workplace/administration/Attic/CmsReInitWorkplace.java,v $
        ...
        switch (getAction()) {
            ...
            default:
                try {
                    ...
                    // error re-initializing, show error dialog
                    setParamMessage(key("error.message.reinitworkplace"));
