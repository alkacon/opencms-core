...
/**
 * Menu item rule which hides a menu item if the user doesn't have the Editor role.<p>
 */
public class CmsMirRequireEditorRole extends A_CmsMenuItemRule {
    ...
    public boolean matches(CmsObject cms, CmsResourceUtil[] resourceUtil) {
        ...
        return !OpenCms.getRoleManager().hasRole(cms, CmsRole.EDITOR);
    }
