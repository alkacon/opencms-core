 ...
 * if the current resource is opened via the item context menus in the publish dialog.<p>
 *
 * @since 8.0.0
 */
public class CmsMirPublishDialogInvisible extends A_CmsMenuItemRule {
    ...
    public boolean matches(CmsObject cms, CmsResourceUtil[] resourceUtil) {
        ...
        String subcontext = (String)cms.getRequestContext().getAttribute(I_CmsMenuItemRule.ATTR_SUB_CONTEXT);
        return CmsGwtConstants.SUBCONTEXT_PUBLISH.equals(subcontext);
