/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/workplace/explorer/menu/CmsMirSitemapInvisible.java,v $
 ...
 * if the current resource is opened via the sitemap.<p>
 * 
 ...
 * @since 8.0.0
 */
public class CmsMirSitemapInvisible extends A_CmsMenuItemRule {
    ...
    public boolean matches(CmsObject cms, CmsResourceUtil[] resourceUtil) {
        ...
        if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(context)) {
            return context.toLowerCase().equals(I_CmsMenuItemRule.CONTEXT_SITEMAP);
        }
        return false;
    }
}
