/*
 * File   : $Source: /alkacon/cvs/opencms/src/org/opencms/workplace/explorer/menu/CmsMirSitemapActive.java,v $
 ...
 * if the current resource is opened via the sitemap editor.<p>
 * 
 ...
 * @since 8.0.0
 */
public class CmsMirSitemapActive extends A_CmsMenuItemRule {
    ...
    public boolean matches(CmsObject cms, CmsResourceUtil[] resourceUtil) {
        ...
        if (CmsStringUtil.isNotEmptyOrWhitespaceOnly(context)) {
            if (context.toLowerCase().equals(I_CmsMenuItemRule.CONTEXT_SITEMAP)) {
                return true;
            }
        }
        return false;
