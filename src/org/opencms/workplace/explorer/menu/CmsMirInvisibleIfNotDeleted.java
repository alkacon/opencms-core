...
/**
 * Hides a context menu option if the file is not deleted.<p>
 */
public class CmsMirInvisibleIfNotDeleted extends A_CmsMenuItemRule {

    /**
     * @see org.opencms.workplace.explorer.menu.A_CmsMenuItemRule#getVisibility(org.opencms.file.CmsObject, org.opencms.workplace.explorer.CmsResourceUtil[])
     */
    @Override
    ...
    public boolean matches(CmsObject cms, CmsResourceUtil[] resourceUtil) {
        ...
        return !resourceUtil[0].getResource().getState().isDeleted();
    }
