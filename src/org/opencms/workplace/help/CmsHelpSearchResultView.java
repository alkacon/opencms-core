...
public class CmsHelpSearchResultView {
    ...
    private void initSearch(CmsSearch search) {
        ...
        search.setMatchesPerPage(3);
        search.setDisplayPages(7);
        search.setSearchRoot("/system/workplace/locales/de/help/");

        String query = CmsEncoder.decode(request.getParameter("query"));
        ...
        if (!m_formCache.containsKey(getRequestUri)) {
            ...
            if (index > 0) {
                ...
                while (entryTokens.hasMoreTokens()) {
                    ...
                    // Undo the possible already performed url encoding for the given uril 
