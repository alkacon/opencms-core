...
public class CmsUpdateDBUpdateOU {
    ...
    private static final String PROJECT_OU_COLUMN = "PROJECT_OU";
    ...
    private static final String TABLE_BACKUP_PROJECTS = "CMS_BACKUP_PROJECTS";
    ...
    private static final String TABLE_CMS_USERS = "CMS_USERS";

    /** Constant for the CMS_PROJECTS table.<p> */
    private static final String TABLE_PROJECTS = "CMS_PROJECTS";
