...
public class CmsFlexRequestDispatcher implements RequestDispatcher {
    ...
    throws ServletException, IOException {
        ...
        if (f_req.exceedsCallLimit(m_vfsTarget)) {
            ...
            throw new ServletException(
                Messages.get().getBundle().key(Messages.ERR_FLEXREQUESTDISPATCHER_INCLUSION_LOOP_1, m_vfsTarget));
        } else {
                    ...
                    if (res_key != null) {
                        ...
                        try {
                            ...
                            if (cacheProperty == null) {
                                ...
                                cacheProperty = OpenCms.getResourceManager().getResourceType(
                                    resource.getTypeId()).getCachePropertyDefault();
                            }
                            cache.putKey(
                                w_res.setCmsCacheKey(
