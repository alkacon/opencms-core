...
@SelectClasses({
    ...
    TestHtmllExtraction.class,
    TestMsPowerPointExtraction.class,
    TestRtfExtraction.class,
    TestMsWordExtraction.class,
    TestPdfExtraction.class,
    TestMsExcelExtraction.class,
    TestXmlDocumentExtraction.class
})
