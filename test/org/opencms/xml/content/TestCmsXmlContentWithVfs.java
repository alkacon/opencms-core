...
public class TestCmsXmlContentWithVfs extends OpenCmsTestCase {
    ...
    public void testMacros() throws Exception {
        ...
        admin.setAddress("Heidestraﬂe 17, M¸nchen");
        cms.writeUser(admin);
        ...
        assertEquals(
            "The author is: Hans Mustermann (Admin), Heidestraﬂe 17, M¸nchen - hans.mustermann@germany.de",
            value1.getStringValue(cms));

        value1 = xmlcontent.addValue(cms, "Option", Locale.GERMAN, 0);
        assertEquals(
            "Der Autor ist: Hans Mustermann (Admin), Heidestraﬂe 17, M¸nchen - hans.mustermann@germany.de",
            value1.getStringValue(cms));
    ...
    public void testResourceBundleFromXmlWithDefault() throws Exception {
        ...
        assertEquals(
            "Dies ist etwas Text EINS NEU ‰ˆ¸ƒ÷‹ﬂÄ",
            xmlcontentDE.getStringValue(cms, "StringOne", Locale.GERMAN));
        assertEquals(
            "Dies ist etwas Text ZWEI NEU ‰ˆ¸ƒ÷‹ﬂÄ",
