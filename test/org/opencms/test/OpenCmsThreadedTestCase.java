...
/**
 * Allows to run an {@link org.opencms.test.OpenCmsJupiterTestCase} in a separate Thread,
...
public class OpenCmsThreadedTestCase extends Thread {
    ...
    private OpenCmsJupiterTestCase m_testCase;
     ...
     */
    public OpenCmsThreadedTestCase(OpenCmsJupiterTestCase testCase, Method method, Object[] parameters) {
