 ...
 * @since 6.0.0
 */
public class OpenCmsTestEnvironment {
     ...
     */
    public OpenCmsTestEnvironment(String arg0) {
     ...
     */
    public OpenCmsTestEnvironment(String arg0, boolean initialize) {
    ...
    /**
     * Fails with the given message.<p>
     *
    ...
    /**
     * Asserts that the condition is true.<p>
     *
    ...
    /**
     * Asserts that two values are equal.<p>
     *
     ...
     * Asserts that two values are equal.<p>
     *
     * @param message the message on failure
     * @param expected the expected value
     * @param actual the actual value
     */
    ...
    throws Exception {
        ...
        for (int i = 0; i < n; i++) {
            ...
            List<CmsProperty> props = generateProperties(cms, maxProps, propValueLength, propertyDistribution);
            try {
                OpenCmsTestEnvironment.importTestResource(cms, rfsName, vfsName, type, props);
                writtenFiles++;
            } catch (Exception e) {
     ...
     *
     * Methods in this class, that is {@link OpenCmsTestEnvironment} are ignored.<p>
     *
    ...
    protected static String getCurrentTestClass() {
        ...
        for (int i = 1; i < stackTraceElements.length; i++) {
            ...
            if (result.indexOf(OpenCmsTestEnvironment.class.getName()) == -1) {
