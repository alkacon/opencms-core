...
/**
 * Unit test for {@link org.opencms.file.CmsResourceFilter}.
 * <p>
 * 
...
public class TestCmsResourceFilter extends OpenCmsTestCase {
     ...
     */
    public TestCmsResourceFilter(String arg0) {
    ...
    public static Test suite() {
        ...
        suite.setName(TestCmsResourceFilter.class.getName());

        suite.addTest(new TestCmsResourceFilter("testAddRequireFolder"));
    ...
    /**
     * Tests the given filter if it only returns folders.
     * <p>
     * 
     ...
     * {@link CmsResourceFilter#addRequireFolder()}).
     * <p>
     * 
