/*
 * File   : $Source: /alkacon/cvs/opencms/prototyp/js/Attic/opencms_timer.js,v $
...
function changeDay(day)
{
	...
	if(day>=wday && day<(mday+wday))
	{
		for(i=0; i<37; i++)
		{
			eval(imgonlyr+'images[i].src = "pics/empty.gif"');
		}
		eval(imgonlyr+'images[hilf2].src = "pics/circle.gif"');
		if((day-hilf)<10)
			{
